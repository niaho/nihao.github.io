...
/*
CREATE TABLE EMPLOYEES2 (EMPLOYEE_ID NUMBER(6),first_name  VARCHAR2(25),LAST_NAME  VARCHAR2(25),SALARY  NUMBER(8,2), DEPARTMENT_ID  VARCHAR2(10),JOB_ID  VARCHAR2(10),EMAIL  VARCHAR2(25),HIRE_DATE  DATE);
*/
...
//	return ;
	...
	(void)sprintf(insertst1, "INSERT INTO EMPLOYEES2 (employee_id, first_name,\
