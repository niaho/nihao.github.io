...
static text *username = (text *) "SYSDBA";
static text *password = (text *) "SYSDBA";


/*---------------------------------------------------------------------------
                     STATIC FUNCTION DECLARATIONS 
  ---------------------------------------------------------------------------*/
 void chk_typecoll (cdemoctx *ctx, OCIParam  *parmp, boolean is_array) ;
 void describe_type(cdemoctx *ctx, OCIType *tdo );
void checkerr(OCIError *errhp, sword status);
void initialize(cdemoctx *ctx);
void setup_param( OCIError *errhp, OCIParam *parm, OCITypeCode tc, 
                        ub1 prec, sb1 scale, ub4 len, ub2 csid, ub1 csfrm,
                         OCIType *attr_tdo, OraText *schm, OraText *typn );
OCIType *create_builtin(OCISvcCtx *svchp, OCIEnv *envhp, OCIError *errhp, 
                                 OCIParam *parm, OCIDuration dur);
OCIType *create_usertype( OCISvcCtx *svchp, OCIEnv *envhp, OCIError *errhp, 
                                OCITypeCode tc, ub4 cnt, OCIParam *parm1, OCIParam *parm2,
                         OCIParam *parm3, OCIParam *parm4, OCIParam *parm5, OCIDuration dur);
void build_data(OCIEnv *envhp, OCIError *errhp, OCISvcCtx *svchp );
...
void setup_param(OCIError *errhp,OCIParam *parm,OCITypeCode tc,ub1 prec,sb1 scale,ub4 len,ub2 csid,ub1 csfrm,OCIType *attr_tdo,OraText *schm,OraText *typn)
{  
...
OCIType *create_builtin(OCISvcCtx *svchp, OCIEnv *envhp, OCIError *errhp,OCIParam *parm, OCIDuration dur)
{
  ub2 tc;
  OCIType *builtin;
  ub4 siz;
...
/* Using OCIDescribeAny to describe type */
 void chk_type (cdemoctx *ctx,OCIParam  *parmp)
{
