...
/*
create table employees( EMPLOYEE_ID   NUMBER(6), LAST_NAME  VARCHAR2(25),SALARY NUMBER(8,2),DEPARTMENT_ID  VARCHAR2(10),JOB_ID  VARCHAR2(10),EMAIL VARCHAR2(25),HIRE_DATE DATE );
*/
...
static CONST OraText *database = (OraText *)"localhost:5139/system";
static CONST OraText *username = (OraText *)"SYSDBA";
static CONST OraText *password = (OraText *)"SYSDBA";
static CONST OraText *appusername = (OraText *)"SYSDBA"; 
static CONST OraText *apppassword = (OraText *)"SYSDBA";
...
static char hdate[MAXTHREAD][12]= 
   {"2001-12-18", "2002-12-18", "2003-12-18", "2004-12-18", "2005-12-18",
    "2006-12-18", "2007-12-18", "2008-12-18", "2009-12-18", "2010-12-18"};
...
int main(int argc, char *argv[])
{
    ...
    if (lstat = OCIConnectionPoolCreate(envhp,
                     ...
                     appusername,(sb4)strlen((  char *)appusername),
                     apppassword,(sb4)strlen((  char *)apppassword)
                     ,OCI_DEFAULT))
    {
...
static void threadFunction (dvoid *arg)
{
    ...
    checkerr(errhp2, OCIStmtPrepare (stmthp, errhp2, (CONST OraText *)insertst1,
             (ub4)strlen(( char *)insertst1), OCI_NTV_SYNTAX, 
             OCI_DEFAULT));
    ...
    checkerr(errhp2, OCILogoff(svchp, errhp2));
...
static void deleteRows()
{
    ...
    checkerr(errhp, OCIStmtPrepare (stmthp, errhp, (text *)deletest1,
             (ub4)strlen(( char *)deletest1), OCI_NTV_SYNTAX, 
             OCI_DEFAULT));
...
static void queryRows() 
{
    ...
    checkerr(errhp, OCIStmtPrepare (stmthp, errhp, (text *)selectst1,
            (ub4)strlen(( char *)selectst1), OCI_NTV_SYNTAX, 
            OCI_DEFAULT));
