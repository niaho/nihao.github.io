...
/*
create table emp( empno  INTEGER, ename varchar(64), job varchar(64), sal float, deptno integer);
create table dept( deptno  INTEGER, dname varchar(64));
*/
...
static CONST OraText *password =(OraText *)"SYSDBA"; /* no password needed for proxy*/
