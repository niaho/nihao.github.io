...
DESCRIPTION
Kunlun Call Interface - Ansi Prototypes
...
KCIAttrGet
KCIAttrSet
KCIBindArrayOfStruct
KCIBindByName
KCIBindByPos
KCIBindDynamic
KCIBindObject
KCIBreak
KCIConnectionPoolCreate
KCISessionPoolCreate
KCISessionGet
KCISessionRelease
KCIDateTimeAssign
KCIDateTimeCheck
...
KCIDateTimeGetTime
KCIDateTimeGetTime
KCIDateTimeGetTimeZoneOffset
KCIDateTimeSysTimeStamp
KCIDateTimeIntervalAdd
KCIDateTimeIntervalSub
KCIDateTimeConstruct
KCIDateTimeSubtract
KCIDateTimeToText
KCIDateTimeGetTimeZoneName
KCIDateTimeToArray
KCIDateTimeFromArray
KCIRowidToChar
KCIDefineArrayOfStruct
KCIDefineByPos
KCIDefineDynamic
KCIDefineObject
KCIDescAlloc
...
KCILobCharSetId
KCILobCopy
KCILobCreateTemporary
KCILobDisableBuffering
KCILobEnableBuffering
KCILobErase
KCILobOpen
KCILobClose
KCILobFileClose
...
KCILobWrite
KCILobWriteAppend
KCILobGetStorageLimit
KCILobGetOptions
KCILobSetOptions
KCILobGetContentType
KCILobSetContentType
KCILogoff
KCILogon
KCILogon2
KCIMemoryFree
...
KCIDescriptorAlloc
KCIDescriptorFree
KCIArrayDescriptorAlloc
KCIArrayDescriptorFree
KCIEnvInit
KCIServerAttach
KCISessionBegin
KCISessionEnd
...
KCILobWriteAppend2
KCILobGetStorageLimit
KCISecurityOpenWallet
KCISecurityCloseWallet
KCISecurityCreateWallet
KCISecurityDestroyWallet
KCISecurityStorePersona
KCISecurityOpenPersona
KCISecurityClosePersona
KCISecurityRemovePersona
KCISecurityCreatePersona
KCISecuritySetProtection
KCISecurityGetProtection
KCISecurityRemoveIdentity
KCISecurityCreateIdentity
KCISecurityAbortIdentity
KCISecurityFreeIdentity
KCISecurityStoreTrustedIdentity
KCISecuritySign
KCISecuritySignExpansion
KCISecurityVerify
KCISecurityValidate
KCISecuritySignDetached
KCISecuritySignDetExpansion
KCISecurityVerifyDetached
KCISecurity_PKEncrypt
KCISecurityPKEncryptExpansion
KCISecurityPKDecrypt
KCISecurityEncrypt
KCISecurityEncryptExpansion
KCISecurityDecrypt
KCISecurityEnvelope
KCISecurityDeEnvelope
KCISecurityKeyedHash
KCISecurityKeyedHashExpansion
KCISecurityHash
KCISecurityHashExpansion
KCISecuritySeedRandom
KCISecurityRandomBytes
KCISecurityRandomNumber
KCISecurityInitBlock
KCISecurityReuseBlock
KCISecurityPurgeBlock
KCISecuritySetBlock
KCISecurityGetIdentity
KCIAQEnq
KCIAQDeq
KCIAQEnqArray
KCIAQEnqStreaming
...
KCIContextSetValue
KCIContextGetValue
KCIContextClearValue
KCIMemorySetCurrentIDs
KCIPicklerTdsCtxInit
KCIPicklerTdsInit
KCIPicklerTdsCreateElementNumber
KCIPicklerTdsCreateElementChar
KCIPicklerTdsCreateElementVarchar
KCIPicklerTdsCreateElementRaw
KCIPicklerTdsCreateElement
KCIPicklerTdsAddAttr
KCIPicklerTdsGenerate
KCIPicklerTdsGetAttr
KCIPicklerFdoInit
KCIPicklerFdoFree
KCIPicklerImageInit
KCIPicklerImageFree
KCIPicklerImageAddScalar
KCIPicklerImageAddNullScalar
KCIPicklerImageGenerate
KCIPicklerImageGetScalarSize
KCIPicklerImageGetScalar
KCIPicklerImageCollBegin
KCIPicklerImageCollAddScalar
KCIPicklerImageCollEnd
KCIPicklerImageCollBeginScan
KCIPicklerImageCollGetScalarSize
KCIPicklerImageCollGetScalar
KCIAnyDataGetType
KCIAnyDataIsNull
KCIAnyDataConvert
KCIAnyDataBeginCreate
KCIAnyDataAttrSet
KCIAnyDataCollAddElem
KCIAnyDataEndCreate
KCIAnyDataAccess
KCIAnyDataGetCurrAttrNum
KCIAnyDataAttrGet
KCIAnyDataCollGetElem
KCIPicklerTdsCtxInit
KCIPicklerTdsInit
KCIPicklerTdsCreateElementNumber
KCIPicklerTdsCreateElementChar
...
KCIAnyDataAttrGet
KCIAnyDataCollGetElem
KCIAnyDataSetBeginCreate
KCIAnyDataSetDestroy
KCIAnyDataSetAddInstance
KCIAnyDataSetEndCreate
KCIAnyDataSetGetType
KCIAnyDataSetGetCount
KCIAnyDataSetGetInstance
KCIFormatString
KCINlsGetInfo
KCINlsNameMap
KCIMultiByteToWideChar
KCIMultiByteInSizeToWideChar
KCIWideCharToMultiByte
KCIWideCharInSizeToMultiByte
KCIWideCharStrcmp
KCIWideCharStrncmp
KCIWideCharStrcat
*KCIWideCharStrchr
...
KCIMultiByteStrncat
KCIMultiByteStrncpy
KCIMultiByteStrnDisplayLength
KCIMultiByteStrCaseConversion
KCICharSetToUnicode
KCIUnicodeToCharSet
KCINlsCharSetConvert
KCINlsEnvironmentVariableGet
KCIMessageOpen
KCIMessageGet
KCIThreadMutexInit
KCIThreadMutexDestroy
KCIThreadMutexAcquire
KCIThreadMutexRelease
KCIThreadKeyInit
KCIThreadKeyDestroy
KCIThreadKeyGet
KCIThreadKeySet
...
KCIThreadIdNull
KCIThreadCreate
KCISubscriptionRegister
KCISubscriptionPost
KCISubscriptionUnRegister
KCISubscriptionDisable
KCISubscriptionEnable
KCIDateTimeGetTime
KCIDateTimeGetDate
KCIDateTimeGetTimeZoneOffset
KCIDateTimeConstruct
...
KCIIntervalDivide
KCIIntervalCompare
KCIIntervalFromNumber
KCIIntervalFromText
KCIIntervalToText
KCIIntervalToNumber
KCIIntervalCheck
KCIIntervalAssign
KCIIntervalSetYearMonth
KCIIntervalGetYearMonth
KCIIntervalSetDaySecond
KCIIntervalGetDaySecond
KCIDateTimeToArray
KCIDateTimeFromArray
KCIDateTimeGetTimeZoneName
KCIIntervalFromTZ
KCIConnectionPoolCreate
KCIConnectionPoolDestroy
KCISessionPoolCreate
KCISessionPoolDestroy
KCISessionGet
KCISessionRelease
KCIAppCtxSet
KCIAppCtxClearAll
...
Syntax
sword KCIAttrGet ( const void    *trgthndlp,
ub4            trghndltyp,
void          *attributep,
ub4            *sizep,
ub4            attrtype,
...
Syntax
sword KCIAttrSet ( void       *trgthndlp,
ub4         trghndltyp,
void       *attributep,
ub4         size,
ub4         attrtype,
...
most attributes as the size is already known by the KCI library. For text*
...
KCIBindArrayOfStruct()
Name
KCI Bind for Array of Structures
Purpose
This call sets up the skip parameters for a static array bind.
Syntax
sword KCIBindArrayOfStruct ( KCIBind     *bindp,
KCIError    *errhp,
ub4         pvskip,
ub4         indskip,
ub4         alskip,
...
KCI Bind by Name
Purpose
Creates an assKCIation between a program variable and a placeholder in a SQL
...
assKCIation between the address of a program variable and a placeholder in a
...
parameter.
Data in an KCI application can be bound to placeholders statically or
...
setting the mode parameter of this call to KCI_DATA_AT_EXEC.
...
page 5-16.
Both KCIBindByName() and KCIBindByPos() take as a parameter a bind handle,
...
ways:
If arrays of structures are being utilized, KCIBindArrayOfStruct() must
be called to set up the necessary skip parameters.
If data is being provided dynamically at runtime, and the application
will be using user-defined callback functions, KCIBindDynamic() must
be called to register the callbacks.
If a named data type is being bound, KCIBindObject() must be called to
...
bind in KCI terms. Additional attributes of the array bind (not bind to a
column of ARRAY type) are set up in KCIBindArrayOfStruct() call.
...
initialized by KCIBindObject(). For named data type and REF binds, the bind
values are unpickled into the Object Cache. The KCI object navigational calls
can then be used to navigate the objects and the refs in the Object Cache.
If the KCI_DATA_AT_EXEC mode is specified in the mode parameter, valuep
is ignored for all data types. KCIBindArrayOfStruct() cannot be used and
KCIBindDynamic() must be invoked to provide callback functions if desired.
...
If the KCI_DATA_AT_EXEC mode is specified, valuesz defines the maximum
...
an array of indicator structures is initialized by KCIBindObject().
...
maxarr_len is non-zero, then either KCIBindDynamic() or
KCIBindArrayOfStruct() can be invoked to set up additional bind attributes.
...
KCI_DEFAULT. This is default mode.
KCI_DATA_AT_EXEC. When this mode is selected, the value_sz
parameter defines the maximum size of the data that can be ever
provided at runtime. The application must be ready to provide the KCI
...
with a subsequent call to KCIBindDynamic().
a polling mechanism using calls supplied by the KCI. This mode
is assumed if no callbacks are defined.
For more information about using the KCI_DATA_AT_EXEC mode, see
the section "Runtime Data Allocation and Piecewise Operations" on
page 5-16.
When the allocated buffers are not required any more, they should be
freed by the client.
Related Functions
KCIBindDynamic(), KCIBindObject(), KCIBindArrayOfStruct(), KCIAttrGet()
...
types, this is a pointer to sb2 or an array of sb2s. For named data types,
this pointer is ignored and the actual pointer to the indicator structure or
an array of indicator structures is initialized by KCIBindObject(). Ignored
for dynamic binds.
See the section "Indicator Variables" on page 2-43 for more information about
indicator variables.
alenp (IN/OUT) - pointer to array of actual lengths of array elements. Each
...
KCIBindDynamic()
Name
KCI Bind Dynamic Attributes
Purpose
This call is used to register user callbacks for dynamic data allocation.
Syntax
sword KCIBindDynamic( KCIBind     *bindp,
KCIError    *errhp,
void       *ictxp,
KCICallbackInBind         (icbfp)(
void            *ictxp,
KCIBind          *bindp,
ub4              iter,
ub4              index,
...
data for an UPDATE or INSERT if KCI_DATA_AT_EXEC mode was specified in a
previous call to KCIBindByName() or KCIBindByPos().
The callback function pointers must return KCI_CONTINUE if it the call is
successful. Any return code other than KCI_CONTINUE signals that the client
wishes to abort processing immediately.
For more information about the KCI_DATA_AT_EXEC mode, see the section
"Runtime Data Allocation and Piecewise Operations" on page 5-16.
Parameters
bindp (IN/OUT) - a bind handle returned by a call to KCIBindByName() or
KCIBindByPos().
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
...
following values - KCI_ONE_PIECE, KCI_FIRST_PIECE,
KCI_NEXT_PIECE and KCI_LAST_PIECE.
...
alenpp (OUT) - a pointer to a storage for KCI to fill in the size of the bind
value/piece after it has been read.
piecep (IN/OUT) - which piece of the bind value. It will be set by the
library to be one of the following values - KCI_ONE_PIECE or
KCI_NEXT_PIECE. The callback function can leave it unchanged or set
it to KCI_FIRST_PIECE or KCI_LAST_PIECE. By default -
KCI_ONE_PIECE.
...
Syntax
sword KCIBindObject ( KCIBind          *bindp,
KCIError         *errhp,
const KCIType    *type,
void            **pgvpp,
ub4              *pvszsp,
...
or a REF. An error will be returned if this function is called when the KCI
...
KCIType for the named data type being defined.  The TDO can be retrieved
with a call to KCITypeByName().
If the KCI_DATA_AT_EXEC mode was specified in KCIbindn() or KCIbindp(), the
pointers to the IN buffers are obtained either using the callback icbfp
registered in the KCIBindDynamic() call or by the KCIStmtSetPieceInfo() call.
...
KCIBindDynamic() or by setting the pointer to the buffer in the buffer passed
in by KCIStmtSetPieceInfo() called when KCIStmtExecute() returned
KCI_NEED_DATA. The memory of these client library- allocated buffers must be
freed when not in use anymore by using the KCIObjectFreee() call.
Parameters
bindp ( IN/OUT) - the bind handle returned by the call to KCIBindByName()
or KCIBindByPos().
errhp ( IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
type ( IN) - points to the TDO which describes the type of the program
variable being bound. Retrieved by calling KCITypeByName().
...
object cache.
pgvpp is ignored if the KCI_DATA_AT_EXEC mode is set. Then the Named
Data Type buffers are requested at runtime. For static array binds, skip
factors may be specified using the KCIBindArrayOfStruct() call. The skip
...
Data Types and REFs received. pvszsp is ignored if the KCI_DATA_AT_EXEC
...
indpp is ignored if the KCI_DATA_AT_EXEC mode is set. Then the indicator
...
indszp is ignored if the KCI_DATA_AT_EXEC mode is set. Then the indicator
...
executing KCI function that is assKCIated with a server .
Syntax
sword KCIBreak ( void      *hndlp,
KCIError   *errhp);
Comments
This call performs an immediate (asynchronous) abort of any currently
executing KCI function that is assKCIated with a server. It is normally used
to stop a long-running KCI call being processed on the server.
...
Syntax:
KCIConnectionPoolCreate (KCIEnv *envhp, KCIError *errhp, KCICPool *poolhp,
KunText **poolName, sb4 *poolNameLen,
const KunText *dblink, sb4 dblinkLen,
ub4 connMin, ub4 connMax, ub4 connIncr,
const KunText *poolUsername, sb4 poolUserLen,
const KunText *poolPassword, sb4 poolPassLen,
ub4 mode)
Comments:
This call is used to create a connection pool. conn_min connections
to the database are started on calling KCIConnectionPoolCreate.

Parameters:
envhp (IN/OUT)  - A pointer to the environment where the Conencton Pool
is to be created
errhp (IN/OUT)  - An error handle which can be passed to KCIErrorGet().
...
KCIConnectionPoolCreate() is called.
...
mode (IN) - The modes supported are KCI_DEFAULT and
KCI_CPOOL_REINITIALIZE
...
Syntax:
KCIConnectionPoolDestroy (KCICPool *poolhp, KCIError *errhp, ub4 mode)

Comments:
On calling KCIConnectionPoolDestroy, all the open connections in the pool
are closed and the pool is destroyed.

Parameters:
poolhp (IN/OUT) - An initialiazed pool handle.
errhp (IN/OUT)  - An error handle which can be passed to KCIErrorGet().
mode (IN)       - Currently, KCIConnectionPoolDestroy() will support only
the KCI_DEFAULT mode.
...
Syntax:
sword KCISessionPoolCreate (KCIEnv *envhp, KCIError *errhp, KCISpool *spoolhp,
KunText **poolName, ub4 *poolNameLen,
const KunText *connStr, ub4 connStrLen,
ub4 sessMin, ub4 sessMax, ub4 sessIncr,
KunText *userid,  ub4 useridLen,
KunText *password, ub4 passwordLen,
ub4 mode)

Comments:
When KCISessionPoolCreate is called, a session pool is initialized for
the assKCIated environment and the database specified by the
...
unless the KCI_ATTR_SPOOL_FORCEGET is set.
...
mode(IN) - May be KCI_DEFAULT, KCI_SPC_SPOOL_REINITIALIZE, or
KCI_SPC_SPOOL_HOMOGENEOUS.
...
Syntax:
sword KCISessionPoolDestroy (KCISPool *spoolhp, KCIError *errhp, ub4 mode)

Comments:
spoolhp (IN/OUT) - The pool handle of the session pool to be destroyed.
errhp (IN/OUT) - An error handle which can be passed to KCIErrorGet().
mode (IN) - Currently only KCI_DEFAULT mode is supported.
...
Syntax:
sword KCISessionGet(KCIenv *envhp, KCIError *errhp, KCISvcCtx **p_svctx,
KCIAuthInfo *authhp,
KunText *poolName, ub4 poolName_len,
const KunText *tagInfo, ub4 tagInfo_len,
KunText **retTagInfo, ub4 *retTagInfo_len,
boolean *found,
ub4 mode)

Comments:
envhp (IN/OUT) - KCI environment handle.
errhp (IN/OUT) - KCI error handle to be passed to KCIErrorGet().
p_svctx (IN/OUT) - Address of an KCI service context pointer. This will be
filled with a server and session handle, attached to the
pool.
authhp (IN/OUT) - KCI Authentication Information handle.
poolName (IN) - This indicates the session/connection pool to get the
session/connection from in the KCI_SPOOL/KCI_CPOOL mode.
In the KCI_DEFAULT mode it refers to the connect string.
...
mode (IN) - The supported modes are KCI_DEFAULT, KCI_CRED_PROXY and
KCI_GET_SPOOL_MATCHANY, KCI_SPOOL and KCI_CPOOL. KCI_SPOOL and
KCI_CPOOL are mutually exclusive.

Returns:
SUCCESS -  if a session was successfully returned into p_svctx.
SUCCESS_WITH_INFO - if a session was successfully returned into p_svctx and the
...
KunText *tag, ub4 tag_len,
ub4 mode);

Comments:
p_svctx (IN/OUT) - The service context assKCIated with the session/connection.
errhp (IN/OUT) - KCI error handle to be passed to KCIErrorGet().
tag (IN) - Only used for Session Pooling.
This parameter will be ignored unless mode KCI_RLS_SPOOL_RETAG is
...
KCI_RLS_SPOOL_RETAG is set.
mode (IN) - The supported modes are KCI_DEFAULT, KCI_RLS_SPOOL_DROPSESS,
KCI_RLS_SPOOL_RETAG. The last 2 are only valid for Session Pooling.
When KCI_RLS_SPOOL_DROPSESS is specified, the session
will be removed from the session pool. If KCI_RLS_SPOOL_RETAG
...
-----------------------------------------------------------------------------
------------------------------KCIDateTimeAssign --------------------------
sword KCIDateTimeAssign(void *hndl, KCIError *err, const KCIDateTime *from,
KCIDateTime *to);
NAME: KCIDateTimeAssign - KCIDateTime Assignment
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
------------------------------KCIDateTimeCheck----------------------------
sword KCIDateTimeCheck(void *hndl, KCIError *err, const KCIDateTime *date,
ub4 *valid );
NAME: KCIDateTimeCheck - KCIDateTime CHecK if the given date is valid
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
----------                   ----------      -----
KCI_DATE_INVALID_DAY         0x1             Bad day
KCI_DATE_DAY_BELOW_VALID     0x2             Bad DAy Low/high bit (1=low)
KCI_DATE_INVALID_MONTH       0x4             Bad MOnth
KCI_DATE_MONTH_BELOW_VALID   0x8             Bad MOnth Low/high bit (1=low)
KCI_DATE_INVALID_YEAR        0x10            Bad YeaR
KCI_DATE_YEAR_BELOW_VALID    0x20            Bad YeaR Low/high bit (1=low)
KCI_DATE_INVALID_HOUR        0x40            Bad HouR
KCI_DATE_HOUR_BELOW_VALID    0x80            Bad HouR Low/high bit (1=low)
KCI_DATE_INVALID_MINUTE      0x100           Bad MiNute
KCI_DATE_MINUTE_BELOW_VALID  0x200           Bad MiNute Low/high bit (1=low)
KCI_DATE_INVALID_SECOND      0x400           Bad SeCond
KCI_DATE_SECOND_BELOW_VALID  0x800           bad second Low/high bit (1=low)
KCI_DATE_DAY_MISSING_FROM_1582 0x1000        Day is one of those "missing"
from 1582
KCI_DATE_YEAR_ZERO           0x2000          Year may not equal zero
KCI_DATE_INVALID_TIMEZONE    0x4000          Bad Timezone
KCI_DATE_INVALID_FORMAT      0x8000          Bad date format input
...
would be KCI_DATE_INVALID_DAY | KCI_DATE_DAY_BELOW_VALID |
KCI_DATE_INVALID_HOUR | KCI_DATE_INVALID_MINUTE

DESCRIPTION:
Check if the given date is valid.
RETURNS:
KCI_SUCCESS if the function completes successfully.
KCI_INVALID_HANDLE if 'err' is NULL.
KCI_ERROR if
'date' and 'valid' pointers are NULL pointers

------------------------------- KCIDateTimeCompare----------------------------
sword KCIDateTimeCompare(void *hndl, KCIError *err, const KCIDateTime *date1,
const KCIDateTime *date2,  sword *result );
NAME: KCIDateTimeCompare - KCIDateTime CoMPare dates
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
1 if date1 > date2
DESCRIPTION:
The function KCIDateCompare compares two dates. It returns -1 if
...
KCIDateTime *outdate);
NAME: KCIDateTimeConvert - Conversion between different DATETIME types
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
---------------------------- KCIDateTimeFromText-----------------------
sword KCIDateTimeFromText(void *hndl, KCIError *err, const KunText *date_str,
size_t d_str_length, const KunText *fmt, ub1 fmt_length,
const KunText *lang_name, size_t lang_length, KCIDateTime *date );
NAME: KCIDateTimeFromText - KCIDateTime convert String FROM Date
PARAMETERS:
...
days and months are specified, if null i.e. (KunText *)0,
...
KCIDateTime descriptor according to the specified format. Refer to
...
--------------------------- KCIDateTimeGetDate-------------------------
sword KCIDateTimeGetDate(void *hndl, KCIError *err,  const KCIDateTime *date,
sb2 *year, ub1 *month, ub1 *day );
NAME: KCIDateTimeGetDate - KCIDateTime Get Date (year, month, day)
portion of DATETIME.
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
...
The error recorded in 'err' can be retrieved by calling
KCIErrorGet().
datetime (IN) - Pointer to KCIDateTime
year      (OUT) - year value
month     (OUT) - month value
day       (OUT) - day value

--------------------------- KCIDateTimeGetTime ------------------------
sword KCIDateTimeGetTime(void *hndl, KCIError *err, KCIDateTime *datetime,
ub1 *hour, ub1 *minute, ub1 *sec, ub4 *fsec);
NAME: KCIDateTimeGetTime - KCIDateTime Get Time (hour, min, second,
...
--------------------------- KCIDateTimeGetTimeZoneOffset ----------------------
sword KCIDateTimeGetTimeZoneOffset(void *hndl,KCIError *err,const
KCIDateTime *datetime,sb1 *hour,sb1  *minute);

NAME: KCIDateTimeGetTimeZoneOffset - KCIDateTime Get TimeZone (hour, minute)
portion of DATETIME.
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
...
--------------------------- KCIDateTimeSysTimeStamp---------------------
sword KCIDateTimeSysTimeStamp(void *hndl, KCIError *err,
KCIDateTime *sys_date );

NAME: KCIDateTimeSysTimeStamp - Returns system date/time as a TimeStamp with
timezone
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
...
NAME: KCIDateTimeIntervalAdd - Adds an interval to datetime
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
------------------------------KCIDateTimeIntervalSub----------------------
sword KCIDateTimeIntervalSub(void *hndl, KCIError *err, KCIDateTime *datetime,
KCIInterval *inter, KCIDateTime *outdatetime);
NAME: KCIDateTimeIntervalSub - Subtracts an interval from a datetime
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
--------------------------- KCIDateTimeConstruct-------------------------
sword KCIDateTimeConstruct(void  *hndl,KCIError *err,KCIDateTime *datetime,
sb2 year,ub1 month,ub1 day,ub1 hour,ub1 min,ub1 sec,ub4 fsec,
KunText  *timezone,size_t timezone_length);

NAME: KCIDateTimeConstruct - Construct an KCIDateTime. Only the relevant
fields for the KCIDateTime descriptor types are used.
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
type of the KCIDateTime descriptor. Only the relevant fields based
...
RETURNS:
KCI_SUCCESS if the function completes successfully.
KCI_ERROR if datetime is not valid.

------------------------------KCIDateTimeSubtract-----------------------
sword KCIDateTimeSubtract(void *hndl, KCIError *err, KCIDateTime *indate1,
KCIDateTime *indate2, KCIInterval *inter);
NAME: KCIDateTimeSubtract - subtracts two datetimes to return an interval
PARAMETERS:
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
const KunText *fmt, ub1 fmt_length, ub1 fsprec,
const KunText *lang_name, size_t lang_length,
ub4 *buf_size, KunText *buf );
NAME: KCIDateTimeToText - KCIDateTime convert date TO String
PARAMETERS:
hndl (IN) - Session/Env handle. If Session Handle is passed, the
conversion takes place in session NLS_LANGUAGE and
session NLS_CALENDAR, otherwise the default is used.
...
fmt (IN) - conversion format, if null string pointer (KunText*)0, then
...
----------------------------KCIDateTimeGetTimeZoneName------------------------
sword KCIDateTimeGetTimeZoneName(void *hndl,
KCIError *err,
const KCIDateTime *datetime,
ub1 *buf,
ub4 *buflen);
NAME KCIDateTimeGetTimeZoneName - KCI DateTime Get the Time Zone Name
PARAMETERS:
hndl (IN)      - Session/Env handle.
err (IN/OUT)   - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
The error recorded in 'err' can be retrieved by calling
KCIErrorGet().
datetime (IN)   - Pointer to an KCIDateTime.
...
---------------------------------KCIDateTimeToArray----------------------------
sword KCIDateTimeToArray(void *hndl,
KCIError *err,
const KCIDateTime *datetime,
const KCIInterval *reftz,
ub1 *outarray,
ub4 *len
ub1 *fsprec);
NAME KCIDateTimeToArray - KCI DateTime convert To Array format
PARAMETERS:
hndl (IN)      - Session/Env handle.
err (IN/OUT)   - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
The error recorded in 'err' can be retrieved by calling
KCIErrorGet().
datetime (IN)   - Pointer to KCIDateTime to be converted.
...
--------------------------------KCIDateTimeFromArray---------------------------
sword KCIDateTimeFromArray(void *hndl,
KCIError *err,
ub1 *inarray,
ub4 len
ub1 type
KCIDateTime *datetime,
KCIInterval *reftz,
ub1 fsprec);
NAME KCIDateTimeFromArray - KCI DateTime convert From Array format
PARAMETERS:
hndl (IN)      - Session/Env handle.
err (IN/OUT)   - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
datetime (OUT) - Pointer to the result KCIDateTime.
reftz (IN)     - timezone interval used with SQLT_TIMESTAMP_LTZ.
fsprec (IN)    - fractionl seconds digits of precision (0-9).
DESCRIPTION:
Returns a pointer to an KCIDateTime of type type converted from
the inarray.
RETURNS:
KCI_SUCCESS if the function completes successfully.
KCI_INVALID_HANDLE if 'err' is NULL.
...
Syntax
sword KCIRowidToChar( KCIRowid *rowidDesc,
KunText *outbfp,
ub2 *outbflp,
KCIError *errhp)
...
KCIBindByPos or KCIBindByName call and used to query a row at a
desired ROWID.

Parameters
rowidDesc (IN)   - rowid DESCriptor which is allocated from KCIDescritorAlloc
...
KCIDefineArrayOfStruct()
Name
KCI Define for Array of Structures
Purpose
This call specifies additional attributes necessary for a static array define.
Syntax
sword KCIDefineArrayOfStruct ( KCIDefine   *defnp,
KCIError    *errhp,
ub4         pvskip,
ub4         indskip,
ub4         rlskip,
...
KCIDefineByPos()
Name
KCI Define By Position
Purpose
AssKCIates an item in a select-list with the type and output data buffer.
Syntax
sb4 KCIDefineByPos (
KCIStmt     *stmtp,
KCIDefine   **defnp,
...
returns data to your KCI application.
...
first call is to KCIDefineByPos(), which defines the minimal attributes
required to specify the fetch.
This call takes as a parameter a define handle, which must have been
previously allocated with a call to KCIHandleAlloc().
Following the call to KCIDefineByPos() additional define calls may be
necessary for certain data types or fetch modes:
A call to KCIDefineArrayOfStruct() is necessary to set up skip parameters
for an array fetch of multiple columns.
A call to KCIDefineObject() is necessary to set up the appropriate
attributes of a named data type fetch. In this case the data buffer pointer
in KCIdefn() is ignored.
Both KCIDefineArrayOfStruct() and KCIDefineObject() must be called
after KCIdefn() in order to fetch multiple rows with a column of named
data types.
For a LOB define, the buffer pointer must be a lob locator of type
KCILobLocator , allocated by the KCIDescAlloc() call. LOB locators, and not
LOB values, are always returned for a LOB column. LOB values can then be
fetched using KCI LOB calls on the fetched locator.
...
If the mode parameter is this call is set to KCI_DYNAMIC_FETCH, the client
...
subsequent call to KCIDefineDynamic(). When the client library needs a
...
a polling mechanism using calls supplied by the KCI. This mode is
assumed if no callbacks are defined. In this case, the fetch call returns the
KCI_NEED_DATA error code, and a piecewise polling method is used
to provide the data.
Related Functions: For more information about using the
KCI_DYNAMIC_FETCH mode, see the section "Runtime Data
...
named data type indicator structures is assKCIated by a subsequent
KCIDefineObject() call.
See the section "Indicator Variables" on page 2-43 for more information about
indicator variables.
...
KCI_DEFAULT. This is the default mode.
KCI_DYNAMIC_FETCH. For applications requiring dynamically
allocated data at the time of fetch, this mode must be used. The user may
additionally call KCIDefineDynamic() to set up a callback function that
...
Related Functions
KCIDefineArrayOfStruct(), KCIDefineDynamic(), KCIDefineObject()
...
KCIDefineDynamic()
Name
KCI Define Dynamic Fetch Attributes
Purpose
This call is used to set the additional attributes required if the
KCI_DYNAMIC_FETCH mode was selected in KCIDefineByPos().
Syntax
sword KCIDefineDynamic( KCIDefine   *defnp,
KCIError    *errhp,
void       *octxp,
KCICallbackDefine (ocbfp)(
void             *octxp,
KCIDefine         *defnp,
ub4               iter,
void             **bufpp,
...
Comments
This call is used to set the additional attributes required if the
KCI_DYNAMIC_FETCH mode has been selected in a call to
KCIDefineByPos().
When the KCI_DYNAMIC_FETCH mode is selected, buffers will be
...
If KCI_DYNAMIC_FETCH mode was selected, and the call to
KCIDefineDynamic() is skipped, then the application can fetch data piecewise
using KCI calls.
For more information about KCI_DYNAMIC_FETCH mode, see the section
"Runtime Data Allocation and Piecewise Operations" on page 5-16.
Parameters
...
The IN value can be KCI_ONE_PIECE, KCI_FIRST_PIECE or
KCI_NEXT_PIECE.
The OUT value can be KCI_ONE_PIECE if the IN value was
KCI_ONE_PIECE.
The OUT value can be KCI_ONE_PIECE or KCI_FIRST_PIECE if
the IN value was KCI_FIRST_PIECE.
The OUT value can only be KCI_NEXT_PIECE or
KCI_LAST_PIECE if the IN value was KCI_NEXT_PIECE.
...
KCIDefineObject()
Name
KCI Define Named Data Type attributes
Purpose
Sets up additional attributes necessary for a Named Data Type define.
Syntax
sword KCIDefineObject ( KCIDefine       *defnp,
KCIError        *errhp,
const KCIType   *type,
void           **pgvpp,
ub4             *pvszsp,
...
An error will be returned if this function is called when the KCI environment
has been initialized in non-Object mode.
This call takes as a paramter a type descriptor object (TDO) of datatype
KCIType for the named data type being defined.  The TDO can be retrieved
with a call to KCITypeByName().
See the description of KCIInitialize() on page 13 - 43 for more information
about initializing the KCI process environment.
Parameters
...
application must call KCIObjectMarkDel() to deallocate the named data type
...
This call returns KCI_SUCCESS if successful, or KCI_INVALID_HANDLE if
...
KCI_DTYPE_SNAP - specifies generation of snapshot descriptor of C
type - KCISnapshot
KCI_DTYPE_LOB - specifies generation of a LOB data type locator of C
type - KCILobLocator
KCI_DTYPE_RSET - specifies generation of a descriptor of C type
KCIResult that references a result set (a number of rows as a result of a
...
statement handle using a function - KCIResultSetToStmt() - which can
then be passed to KCIDefineByPos() and KCIStmtFetch() to retrieve the
rows of the result set.
KCI_DTYPE_ROWID - specifies generation of a ROWID descriptor of C
type KCIRowid.
KCI_DTYPE_COMPLEXOBJECTCOMP - specifies generation of a
complex object retrieval descriptor of C type
KCIComplexObjectComp.
...
Syntax
sword KCIDescFree ( void    *descp,
ub4      type);
Comments
This call frees up storage associated with the descriptor, corresponding to the
type specified in type. Returns KCI_SUCCESS or KCI_INVALID_HANDLE.
All descriptors must be explicitly deallocated. KCI will not deallocate a
...
KCI_DTYPE_SNAP - snapshot descriptor
KCI_DTYPE_LOB - a LOB data type descriptor
KCI_DTYPE_RSET - a descriptor that references a result set (a number
of rows as a result of a query).
KCI_DTYPE_ROWID - a ROWID descriptor
KCI_DTYPE_COMPLEXOBJECTCOMP - a complex object retrieval
descriptor
Related Functions
KCIDescAlloc()
...
Syntax
sword KCIDescribeAny ( KCISvcCtx     *p_svctx,
KCIError      *errhp,
void         *objptr,
ub4           objnm_len,
ub1           objptr_typ,
...
attributes which can be obtained through an KCIAttrGet() call.
An KCIParamGet() on the describe handle returns a parameter descriptor for a
specified position. Parameter positions begin with 1. Calling KCIAttrGet() on
...
KCIDescribeAny(). Calling KCIAttrGet() on the describe handle can also return
the total number of positions.
See the section "Describing" on page 2-33 for more information about describe
operations.
Parameters
TO BE UPDATED
p_svctx (IN/OUT) - a service context handle.
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
...
objptr_typ (IN) - Must be KCI_OTYPE_NAME, KCI_OTYPE_REF, or KCI_OTYPE_PTR.
info_level (IN) - reserved for future extensions. Pass KCI_DEFAULT.
...
KCIEnvCreate()
Name
KCI ENVironment CREATE
Purpose
This function creates and initializes an environment for the rest of
the KCI functions to work under.  This call is a replacement for both
the KCIInitialize and KCIEnvInit calls.
Syntax
sword KCIEnvCreate  ( KCIEnv        **envhpp,
ub4           mode,
const void   *ctxp,
const void   *(*malocfp)
(void *ctxp,
...
Comments
This call creates an environment for all the KCI calls using the modes
specified by the user. This call can be used instead of the two calls
KCIInitialize and KCIEnvInit. This function returns an environment handle
which is then used by the remaining KCI functions. There can be multiple
environments in KCI each with its own environment modes.  This function
also performs any process level initialization if required by any mode.
For example if the user wants to initialize an environment as KCI_THREADED,
then all libraries that are used by KCI are also initialized in the
threaded mode.

This call should be invoked before anny other KCI call and should be used
instead of the KCIInitialize and KCIEnvInit calls. This is the recommended
call, although KCIInitialize and KCIEnvInit calls will still be supported
for backward compatibility.

envpp (OUT) - a pointer to a handle to the environment.
mode (IN) - specifies initialization of the mode. The valid modes are:
KCI_DEFAULT - default mode.
KCI_THREADED - threaded environment. In this mode, internal data
structures are protected from concurrent accesses by multiple threads.
KCI_OBJECT - will use navigational object interface.
...
KCI_THREADED, this memory allocation routine must be thread safe.
...
KCI_THREADED, this memory free routine must be thread safe.
...
Related Functions
KCIInitialize, KCIEnvInit

KCIEnvNlsCreate()
Name
KCI ENVironment CREATE with NLS info
Purpose
This function does almost everything KCIEnvCreate does, plus enabling setting
of charset and ncharset programmatically, except KCI_UTF16 mode.
Syntax
sword KCIEnvNlsCreate(KCIEnv        **envhpp,
ub4           mode,
void         *ctxp,
void         *(*malocfp)
(void *ctxp,
...
The parameters have the same meaning as the ones in KCIEnvCreate().
...
KCI_UTF16ID is allowed to be set as charset and ncharset.
On the other hand, KCI_UTF16 mode is deprecated with this function.
Applications can achieve the same effects by setting
both charset and ncharset as KCI_UTF16ID.


KCIEnvInit()
Name
KCI INITialize environment
Purpose
This call initializes the KCI environment handle.
Syntax
sword KCIEnvInit ( KCIEnv    **envp,
ub4       mode,
size_t    xtramemsz,
void     **usrmempp );
Comments
Initializes the KCI environment handle. No changes are done on an initialized
handle. If KCI_ERROR or KCI_SUCCESS_WITH_INFO is returned, the
...
mode is KCI_DEFAULT for default mode
xtramemsz (IN) - specifies the amount of user memory to be allocated.
usrmempp (OUT) - returns a pointer to the user memory of size xtramemsz
allocated by the call for the user.
Example
See the description of KCISessionBegin() on page 13-84 for an example showing
the use of KCIEnvInit().
Related Functions
...
The error handle is originally allocated with a call to KCIHandleAlloc().
Parameters
hndlp (IN) - the error handle, in most cases, or the environment handle (for
errors on KCIEnvInit(), KCIHandleAlloc()).
...
KCIExtractInit
Name
KCI Extract Initialize
Purpose
This function initializes the parameter manager.
Syntax
sword KCIExtractInit(void *hndl, KCIError *err);
Comments
...
subsequent calls to KCIExtract routines.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN/OUT) - The KCI environment or session handle.
err (IN/OUT) - The KCI error handle. If there is an error, it is recorded in
err and this function returns KCI_ERROR. Diagnostic information
can be obtained by calling KCIErrorGet().
Related Functions
KCIExtractTerm()

KCIExtractTerm
Name
KCI Extract Terminate
Purpose
This function releases all dynamically allocated storage and may perform
other internal bookkeeping functions.
Syntax
sword KCIExtractTerm(void *hndl, KCIError *err);
Comments
...
Syntax
sword KCIExtractReset(void *hndl, KCIError *err);
Comments
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN/OUT) - The KCI environment or session handle.
...
KCIExtractSetNumKeys
Name
KCI Extract Set Number of Keys
Purpose
Informs the parameter manager of the number of keys that will be registered.
Syntax
sword KCIExtractSetNumKeys(void *hndl, KCIError *err, uword numkeys);
Comments
This routine must be called prior to the first call of KCIExtractSetKey().
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN/OUT) - The KCI environment or session handle.
err (IN/OUT) - The KCI error handle. If there is an error, it is recorded in
...
KCIExtractSetKey
Name
KCI Extract Set Key definition
Purpose
Registers information about a key with the parameter manager.
Syntax
sword KCIExtractSetKey(void *hndl, KCIError *err, const KunText *name,
ub1 type, ub4 flag, const void *defval,
const sb4 *intrange, const KunText *const *strlist);
Comments
This routine must be called after calling KCIExtractSetKey() and before
calling KCIExtractFromFile() or KCIExtractFromStr().
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN/OUT) - The KCI environment or session handle.
err (IN/OUT) - The KCI error handle. If there is an error, it is recorded in
...
type (IN) - The type of the key (KCI_EXTRACT_TYPE_INTEGER,
KCI_EXTRACT_TYPE_KCINUM, KCI_EXTRACT_TYPE_STRING, or
KCI_EXTRACT_TYPE_BOOLEAN).
flag (IN) - Set to KCI_EXTRACT_MULTIPLE if the key can take multiple values
or 0 otherwise.
...
KCIExtractFromFile
Name
KCI Extract parameters From File
Purpose
The keys and their values in the given file are processed.
Syntax
sword KCIExtractFromFile(void *hndl, KCIError *err, ub4 flag,
KunText *filename);
Comments
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
...
KCI_EXTRACT_CASE_SENSITIVE, KCI_EXTRACT_UNIQUE_ABBREVS, or
KCI_EXTRACT_APPEND_VALUES.
filename (IN) - Null-terminated filename string.
Related Functions

KCIExtractFromStr
Name
KCI Extract parameters From String
Purpose
The keys and their values in the given string are processed.
Syntax
sword KCIExtractFromStr(void *hndl, KCIError *err, ub4 flag, KunText *input);
Comments
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN/OUT) - The KCI environment or session handle.
...
KCIExtractToInt
Name
KCI Extract To Integer
Purpose
Gets the integer value for the specified key.
Syntax
sword KCIExtractToInt(void *hndl, KCIError *err, KunText *keyname,
uword valno, sb4 *retval);
Comments
The valno'th value (starting with 0) is returned.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, KCI_NO_DATA, or KCI_ERROR.
KCI_NO_DATA means that there is no valno'th value for this key.
Parameters
hndl (IN) - The KCI environment or session handle.
err (IN/OUT) - The KCI error handle. If there is an error, it is recorded in
err and this function returns KCI_ERROR. Diagnostic information
can be obtained by calling KCIErrorGet().
keyname (IN) - Key name.
...
KCIExtractToBool
Name
KCI Extract To Boolean
Purpose
Gets the boolean value for the specified key.
Syntax
sword KCIExtractToBool(void *hndl, KCIError *err, KunText *keyname,
...
KCIExtractToStr
Name
KCI Extract To String
Purpose
Gets the string value for the specified key.
Syntax
sword KCIExtractToStr(void *hndl, KCIError *err, KunText *keyname,
uword valno, KunText *retval, uword buflen);
Comments
The valno'th value (starting with 0) is returned.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, KCI_NO_DATA, or KCI_ERROR.
KCI_NO_DATA means that there is no valno'th value for this key.
...
Note: The following KCIExtract functions are unavailable in this release

KCIExtractToKCINum
Name
KCI Extract To KCI Number
Purpose
Gets the KCINumber value for the specified key.
Syntax
sword KCIExtractToKCINum(void *hndl, KCIError *err, KunText *keyname,
uword valno, KCINumber *retval);
Comments
The valno'th value (starting with 0) is returned.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, KCI_NO_DATA, or KCI_ERROR.
KCI_NO_DATA means that there is no valno'th value for this key.
...
keyname (IN) - Key name.
valno (IN) - Which value to get for this key.
retval (OUT) - The actual KCINumber value.
Related Functions

KCIExtractToList
Name
KCI Extract To parameter List
Purpose
Generates a list of parameters from the parameter structures that are stored
in memory.
Syntax
sword KCIExtractToList(void *hndl, KCIError *err, uword *numkeys);
Comments
Must be called before KCIExtractValues() is called.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN) - The KCI environment or session handle.
err (IN/OUT) - The KCI error handle. If there is an error, it is recorded in
...
KCIExtractFromList
Name
KCI Extract From parameter List
Purpose
Generates a list of values for the a parameter in the parameter list.
Syntax
sword KCIExtractFromList(void *hndl, KCIError *err, uword index,
KunText *name, ub1 *type, uword *numvals,
void ***values);
Comments
Parameters are specified by an index. KCIExtractToList() must be called prior
...
type (OUT) - Type of the current parameter (KCI_EXTRACT_TYPE_STRING,
KCI_EXTRACT_TYPE_INTEGER, KCI_EXTRACT_TYPE_KCINUM, or
KCI_EXTRACT_TYPE_BOOLEAN)
...
Name
KCIFileClose - Oracle Call Interface FILE i/o CLOSE

Purpose
Close a previously opened file.

Syntax
sword KCIFileClose ( void             *hndl,
KCIError          *err,
KCIFileObject     *filep )

Comments
This function will close a previously opened file. If the function succeeds
then KCI_SUCCESS will be returned, else KCI_ERROR.

Parameters
hndl  (IN) - the KCI environment or session handle.
err (OUT) - the KCI error handle
filep (IN) - the KCIFile file object
...
Name
KCIFileExists - Oracle Call Interface FILE i/o EXIST

Purpose
Check to see if the file exists.

Syntax
sword KCIFileExists ( void           *hndl,
KCIError         *err,
KunText          *filename,
KunText          *path,
ub1              *flag )
...
be set to FALSE.
The function will return KCI_ERROR if any error is encountered, else
it will return KCI_ERROR.

Parameters
hndl(IN) - KCI environment or session handle
err(OUT) - KCI error handle
...
Name
KCIFileFlush - Oracle Call Interface File i/o FLUSH

Purpose
Flush the buffers assKCIated with the file to the disk.

Syntax
sword KCIFileFlush ( void             *hndl,
KCIError          *err,
KCIFileObject     *filep )
...
Name
KCIFileGetLength - Oracle Call Interface FILE i/o GET file LENGTH

Purpose
Get the length of a file.

Syntax
KCIFileGetLength(void           *hndl,
KCIError        *err,
KunText         *filename,
KunText         *path,
ubig_ora        *lenp )
...
Parameters
hndl (IN) - the KCI environment or session handle.
err (OUT) - the KCI error handle.  If  there is an error, it is recorded
in err and this function returns KCI_ERROR.  Diagnostic information can be
obtained by calling KCIErrorGet().
...
Name
KCIFileInit - Oracle Call Interface FILE i/o INITialize

Purpose
Initialize the KCI File I/O package and create the KCIFile context.

Syntax
sword KCIFileInit ( void *hndl,
KCIError *err)

Comments
This function should be called before any of the KCIFile functions are
used.
The function will return KCI_ERROR if any error is encountered, else
it will return KCI_ERROR.
...
Name
KCIFileOpen - Oracle Call Interface File i/o OPEN

Purpose
Open a file.

Syntax
sword KCIFileOpen ( void               *hndl,
KCIError            *err,
KCIFileObject      **filep,
KunText             *filename,
KunText             *path,
...
Comments
KCIFileOpen returns a handle to the open file in filep if the file is
successfully opened.
If one wants to use the standard file objects (stdin, stdout & stderr)
then KCIFileOpen whould be called with the type filed containing the
...
Parameters
hndl (OUT) - the KCI environment or session handle.
err (OUT) - the KCI error handle.  If  there is an error, it is recorded
in err and this function returns KCI_ERROR.  Diagnostic information can be
obtained by calling KCIErrorGet().
...
mode - mode in which to open the file (valid modes are KCI_FILE_READONLY,
KCI_FILE_WRITEONLY, KCI_FILE_READ_WRITE).
create - should the file be created if it does not exist. Valid values
are:
KCI_FILE_TRUNCATE - create a file regardless of whether or not it exists.
If the file already exists overwrite it.
KCI_FILE_EXIST - open it if it exists, else fail.
KCI_FILE_EXCL - fail if the file exists, else create.
KCI_FILE_CREATE - open the file if it exists, and create it if it doesn't.
KCI_FILE_APPEND - set the file pointer to the end of the file prior to
writing(this flag can be OR'ed with KCI_FILE_EXIST or
KCI_FILE_CREATE).
type - file type. Valid values are KCI_FILE_TEXT, KCI_FILE_BIN,
KCI_FILE_STDIN, KCI_FILE_STDOUT and KCI_FILE_STDERR.
...
Name
KCIFileRead - Oracle Call Interface FILE i/o READ

Purpose
Read from a file into a buffer.

Syntax
sword KCIFileRead ( void            *hndl,
KCIError         *err,
KCIFileObject    *filep,
void            *bufp,
ub4               bufl,
...
Related Functions
KCIFileOpen, KCIFileSeek, KCIFileWrite
...
Name
KCIFileSeek - Oracle Call Interface FILE i/o SEEK

Purpose
Perfom a seek to a byte position.

Syntax
sword KCIFileSeek ( void           *hndl,
KCIError        *err,
KCIFileObject   *filep,
uword            origin,
ubig_ora         offset,
...
point may be KCI_FILE_SEEK_BEGINNING (beginning), KCI_FILE_SEEK_CURRENT
(current position), or KCI_FILE_SEEK_END (end of file).
...
can be either KCI_FILE_FORWARD or KCI_FILE_BACKWARD.

Related Function
KCIFileOpen, KCIFileRead, KCIFileWrite
...
Name
KCIFileTerm - Oracle Call Interface FILE i/o TERMinate

Purpose
Terminate the KCI File I/O package and destroy the KCI File context.

Syntax
sword KCIFileTerm ( void *hndl,
KCIError *err )

Comments
After this function has been called no KCIFile function should be used.
The function will return KCI_ERROR if any error is encountered, else
it will return KCI_ERROR.
...
Name
KCIFileWrite - Oracle Call Interface FILE i/o WRITE

Purpose
Write data from buffer into a file.

Syntax
sword KCIFileWrite ( void            *hndl,
KCIError         *err,
KCIFileObject    *filep,
void            *bufp,
ub4               buflen
...
Related Functions
KCIFileOpen, KCIFileSeek, KCIFileRead
...
No diagnostics are available on error. This call returns KCI_SUCCESS if
successful, or KCI_INVALID_HANDLE if an out-of-memory error occurs.
Handles must be allocated using KCIHandleAlloc() before they can be passed
into an KCI call.
Parameters
...
are:
KCI_HTYPE_ERROR - specifies generation of an error report handle of
C type KCIError
KCI_HTYPE_SVCCTX - specifies generation of a service context handle
of C type KCISvcCtx
KCI_HTYPE_STMT - specifies generation of a statement (application
request) handle of C type KCIStmt
KCI_HTYPE_BIND - specifies generation of a bind information handle
of C type KCIBind
KCI_HTYPE_DEFINE - specifies generation of a column definition
handle of C type KCIDefine
KCI_HTYPE_DESCRIBE  - specifies generation of a select list
description handle of C type KCIDesc
KCI_HTYPE_SERVER - specifies generation of a server context handle
of C type KCIServer
KCI_HTYPE_SESSION - specifies generation of an authentication
context handle of C type KCISession
KCI_HTYPE_TRANS - specifies generation of a transaction context
handle of C type KCITrans
KCI_HTYPE_COMPLEXOBJECT - specifies generation of a complex
object retrieval handle of C type KCIComplexObject
KCI_HTYPE_SECURITY - specifies generation of a security handle of C
type KCISecurity
...
Syntax
sword KCIHandleFree ( void     *hndlp,
ub4       type);
Comments
This call frees up storage assKCIated with a handle, corresponding to the type
specified in the type parameter.
This call returns either KCI_SUCCESS or KCI_INVALID_HANDLE.
All handles must be explicitly deallocated. KCI will not deallocate a child
...
are:
KCI_HTYPE_ENV - an environment handle
KCI_HTYPE_ERROR - an error report handle
KCI_HTYPE_SVCCTX - a service context handle
KCI_HTYPE_STMT - a statement (application request) handle
KCI_HTYPE_BIND - a bind information handle
KCI_HTYPE_DEFINE - a column definition handle
KCI_HTYPE_DESCRIBE  - a select list description handle
KCI_HTYPE_SERVER - a server handle
KCI_HTYPE_SESSION - a user authentication handle
KCI_HTYPE_TRANS - a transaction handle
KCI_HTYPE_COMPLEXOBJECT - a complex object retrieval handle
KCI_HTYPE_SECURITY - a security handle
Related Functions
KCIHandleAlloc()
...
KCIInitialize()
Name
KCI Process Initialize
Purpose
Initializes the KCI process environment.
Syntax
sword KCIInitialize ( ub4           mode,
const void   *ctxp,
const void   *(*malocfp)
( void *ctxp,
size_t size ),
...
void *memptr ));
Comments
This call initializes the KCI process environment.
KCIInitialize() must be invoked before any other KCI call.
Parameters
mode (IN) - specifies initialization of the mode. The valid modes are:
KCI_DEFAULT - default mode.
KCI_THREADED - threaded environment. In this mode, internal data
...
memptr - pointer to memory to be freed
Example
See the description of KCIStmtPrepare() on page 13-96 for an example showing
the use of KCIInitialize().
Related Functions
...
Comments
This call performs  KCI related clean up before the KCI process terminates.
If the process is running in shared mode then the KCI process is disconnected
from the shared memory subsystem.

KCITerminate() should be the last KCI call in any process.
...
------------------------ KCIAppCtxSet--------------------------------------
Name
KCI Application context Set
Purpose
Set an attribute and its value for a particular application context
namespace
Syntax
(sword) KCIAppCtxSet((void *) sesshndl, (void *)nsptr,(ub4) nsptrlen,
...
server during the next KCIStatementExecute or KCISessionBegin.
...
mode       (IN)     - mode of operation (KCI_DEFAULT)
...
------------------------ KCIAppCtxClearAll---------------------------------
Name
KCI Application Context Clear all attributes in a namespace
Purpose
To clear the  values all attributes in a namespace
Syntax
(sword) KCIAppCtxClearAll((void *) sesshndl, (void *)nsptr, (ub4) nsptrlen,
(KCIError *)errhp, (ub4)mode);
...
KCIAppCtxSet
---------------------- KCIIntervalAssign ---------------------------------
sword KCIIntervalAssign(void *hndl, KCIError *err,
const KCIInterval *inpinter, KCIInterval *outinter );
...
RETURNS
KCI_INVALID_HANDLE if 'err' is NULL.
KCI_SUCCESS otherwise

---------------------- KCIIntervalCheck ------------------------------------
sword KCIIntervalCheck(void *hndl, KCIError *err, const KCIInterval *interval,
ub4 *valid );
...
Macro name                   Bit number      Error
----------                   ----------      -----
KCI_INTER_INVALID_DAY         0x1           Bad day
KCI_INTER_DAY_BELOW_VALID     0x2           Bad DAy Low/high bit (1=low)
KCI_INTER_INVALID_MONTH       0x4           Bad MOnth
KCI_INTER_MONTH_BELOW_VALID   0x8           Bad MOnth Low/high bit (1=low)
KCI_INTER_INVALID_YEAR        0x10          Bad YeaR
KCI_INTER_YEAR_BELOW_VALID    0x20          Bad YeaR Low/high bit (1=low)
KCI_INTER_INVALID_HOUR        0x40          Bad HouR
KCI_INTER_HOUR_BELOW_VALID    0x80          Bad HouR Low/high bit (1=low)
KCI_INTER_INVALID_MINUTE      0x100         Bad MiNute
KCI_INTER_MINUTE_BELOW_VALID  0x200         Bad MiNute Low/high bit(1=low)
KCI_INTER_INVALID_SECOND      0x400         Bad SeCond
KCI_INTER_SECOND_BELOW_VALID  0x800         bad second Low/high bit(1=low)
KCI_INTER_INVALID_FRACSEC     0x1000        Bad Fractional second
KCI_INTER_FRACSEC_BELOW_VALID 0x2000        Bad fractional second Low/High


RETURNS
KCI_SUCCESS if interval is okay
KCI_INVALID_HANDLE if 'err' is NULL.

---------------------- KCIIntervalCompare -----------------------------------
sword KCIIntervalCompare(void *hndl, KCIError *err, KCIInterval *inter1,
KCIInterval *inter2, sword *result );
...
RETURNS
KCI_SUCCESS on success
KCI_INVALID_HANDLE if 'err' is NULL.
KCI_ERROR if
the two input datetimes are not mutually comparable.

---------------------- KCIIntervalDivide ------------------------------------
sword KCIIntervalDivide(void *hndl, KCIError *err, KCIInterval *dividend,
KCINumber *divisor, KCIInterval *result );
...
---------------------- KCIIntervalFromNumber --------------------
sword KCIIntervalFromNumber(void *hndl, KCIError *err,
KCIInterval *inter, KCINumber *number);
DESCRIPTION
...
---------------------- KCIIntervalFromText ---------------------------------
sword KCIIntervalFromText( void *hndl, KCIError *err, const KunText *inpstr,
...
-------------------------- KCIIntervalAdd ------------------------------
sword KCIIntervalAdd(void *hndl, KCIError *err, KCIInterval *addend1,
KCIInterval *addend2, KCIInterval *result );
NAME KCIIntervalAdd - Adds two intervals
PARAMETERS
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
---------------------- KCIIntervalSubtract -------------------------------
sword KCIIntervalSubtract(void *hndl, KCIError *err, KCIInterval *minuend,
KCIInterval *subtrahend, KCIInterval *result );
NAME - KCIIntervalSubtract - subtracts two intervals
PARAMETERS
hndl (IN) - Session/Env handle.
err (IN/OUT) - error handle. If there is an error, it is
recorded in 'err' and this function returns KCI_ERROR.
...
---------------------- KCIIntervalMultiply ---------------------------------
sword KCIIntervalMultiply(void *hndl, KCIError *err, const KCIInterval *inter,
KCINumber *nfactor, KCIInterval *result );
...
----------------------- KCIIntervalToNumber ---------------------------------
sword KCIIntervalToNumber(void *hndl, KCIError *err, const KCIInterval *inter,
KCINumber *number);
...
ub1 lfprec, ub1 fsprec, KunText *buffer,
...
---------------------- KCIIntervalFromTZ --------------------
sword KCIIntervalFromTZ(void *hndl, KCIError *err, const KunText *inpstring,
size_t str_len, KCIInterval *result);

DESCRIPTION
Retuns an KCI_DTYPE_INTERVAL_DS KCIInterval with the region id (if
...
----------------------- KCIKerbAttrSet ---------------------
sword KCIKerbAttrSet(KCISession *trgthndlp, ub4 auth_mode,
...
KunText *ftgt_principal, ub4 ftgt_principal_len,
KunText *ftgt_realm, ub4 ftgt_realm_len,
KCIError *errhp);
...
KCI_KERBCRED_CLIENT_IDENTIFIER
...
ftgt_sesskey(IN) - Session Key assKCIated with FTGT.
ftgt_sesskey_len (IN) - Length of session key.
ftgt_keytype (IN) -  Type of encryption key used to encrypt FTGT.
ftgt_ticket_flags (IN) - Flags assKCIated with  encryption of FTGT.
...
KCILdaToSvcCtx()
Name
KCI toggle version 7 Lda_Def to SerVice context handle
Purpose
Converts a V7 Lda_Def to a V8 service context handle.
Syntax
sword KCILdaToSvcCtx ( KCISvcCtx  **svchpp,
KCIError   *errhp,
Lda_Def    *ldap );
Comments
...
KCISvcCtxToLda() function.
Parameters
svchpp (IN/OUT) - the service context handle.
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
ldap (IN/OUT) - the V7 logon data area returned by KCISvcCtxToLda() from
...
Syntax
sword KCILobAppend ( KCISvcCtx        *p_svctx,
KCIError         *errhp,
KCILobLocator    *dst_locp,
KCILobLocator    *src_locp );
Comments
...
Parameters
p_svctx (IN) - the service context handle.
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
...
Syntax
sword KCILobAssign ( KCIEnv                *envhp,
KCIError              *errhp,
const KCILobLocator   *src_locp,
KCILobLocator         **dst_locpp );
...
Note: The only difference between this and KCILobLocatorAssign is that this
takes an environment handle whereas KCILobLocatorAssign takes an KCI service
handle

Parameters
envhp (IN/OUT) - KCI environment handle initialized in object mode.
errhp (IN/OUT) - The KCI error handle. If there is an error, it is recorded
in errhp and this function returns KCI_ERROR. Diagnostic information can be
obtained by calling KCIErrorGet().
src_locp (IN) - LOB locator to copy from.
dst_locpp (IN/OUT) - LOB locator to copy to.  The caller must allocate space
for the KCILobLocator by calling KCIDescriptorAlloc().
...
Name
KCI Lob Get Character Set Form

Purpose
Gets the LOB locator's character set fpr,, if any.

Syntax
sword KCILobCharSetForm ( KCIEnv                    *envhp,
KCIError                  *errhp,
const KCILobLocator       *locp,
ub1                       *csfrm );
...
Parameters
envhp (IN/OUT) - KCI environment handle initialized in object mode.
errhp (IN/OUT) - error handle. The KCI error handle. If there is an error, it
is recorded in err and this function returns KCI_ERROR. Diagnostic
information can be obtained by calling KCIErrorGet().
...
See also
KCIErrorGet(), KCILobCharSetId(), KCILobLocatorIsInit
...
Name
KCI Lob get Character Set IDentifier

Purpose
Gets the LOB locator's character set ID, if any.

Syntax
sword KCILobCharSetId ( KCIEnv                    *envhp,
KCIError                  *errhp,
const KCILobLocator       *locp,
ub2                       *csid );
...
See also
KCIErrorGet(), KCILobCharSetForm(), KCILobLocatorIsInit()
...
Syntax
sword KCILobCopy ( KCISvcCtx        *p_svctx,
KCIError         *errhp,
KCILobLocator    *dst_locp,
KCILobLocator    *src_locp,
ub4              amount,
...
See Also
KCIErrorGet(), KCILobAppend(), KCILobWrite(), KCILobTrim()

KCILobCreateTemporary()

Name
KCI Lob Create Temporary

Purpose
Create a Temporary Lob

Syntax
sword KCILobCreateTemporary(KCISvcCtx          *p_svctx,
KCIError           *errhp,
KCILobLocator      *locp,
ub2                 csid,
ub1                 csfrm,
...
lobtype (IN) - the lob type - one of the three constants KCI_TEMP_BLOB,
KCI_TEMP_CLOB and KCI_TEMP_NCLOB
...
of the values: KCI_DURATION_SESSION, KCI_DURATION_CALL
Note: KCI_DURATION_TRANSACTION is NOT supported in 8.1
Related functions
KCILobFreeTemporary()
KCILobIsTemporary()
...
Syntax
sword KCILobDisableBuffering ( KCISvcCtx      *p_svctx,
KCIError       *errhp,
KCILobLocator  *locp);
...
user must explicitly call KCILobFlushBuffer() to do this.
...
Syntax
sword KCILobEnableBuffering ( KCISvcCtx      *p_svctx,
KCIError       *errhp,
KCILobLocator  *locp);
...
KCILobCopy, KCILobAppend, KCILobErase, KCILobGetLength, KCILobTrim
...
Syntax
sword KCILobErase ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4             *amount,
ub4             offset );
...
See Also
KCIErrorGet(), KCILobRead(), KCILobWrite()
...
Syntax
sword KCILobOpen( KCISvcCtx        *p_svctx,
KCIError         *errhp,
KCILobLocator    *locp,
ub1               mode );
...
read-only - KCI_FILE_READONLY, read-write - KCI_FILE_READWRITE
...
Syntax
sword KCILobClose( KCISvcCtx        *p_svctx,
KCIError         *errhp,
KCILobLocator    *locp );
...
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
locp  (IN)  - A locator that was opened using KCILobOpen()
...
Syntax
sword KCILobFileClose ( KCISvcCtx            *p_svctx,
KCIError             *errhp,
KCILobLocator        *filep );
...
See Also
KCIErrorGet(), KCILobFileOpen(), KCILobFileCloseAll(), KCILobFileIsOpen(),
KCILobFileExists(), CREATE DIRECTORY DDL
...
Name
KCI LOB FILE Close All

Purpose
Closes all open FILEs on a given service context.

Syntax
sword KCILobFileCLoseAll ( KCISvcCtx *p_svctx,
KCIError  *errhp );
...
See also
KCILobFileClose(),
KCIErrorGet(), KCILobFileOpen(), KCILobFileIsOpen(),
KCILobFileExists(), CREATE DIRECTORY DDL
...
Syntax
sword KCILobFileExists ( KCISvcCtx     *p_svctx,
KCIError      *errhp,
KCILobLocator *filep,
boolean       *flag );
...
Parameters
p_svctx (IN) - the KCI service context handle.
errhp (IN/OUT) - error handle. The KCI error handle. If there is an error,
it is recorded in err and this function returns KCI_ERROR. Diagnostic
information can be obtained by calling KCIErrorGet().
...
See also
KCIErrorGet, CREATE DIRECTORY (DDL)
...
Name
KCI LOB FILE Get file Name

Purpose
Gets the FILE locator's directory alias and file name.

Syntax
sword KCILobFileGetName ( KCIEnv                   *envhp,
KCIError                 *errhp,
const KCILobLocator      *filep,
KunText                     *dir_alias,
ub2                      *d_length,
KunText                     *filename,
ub2                      *f_length );
...
Comments
Returns the directory alias and file name assKCIated with this file locator.

Parameters
envhp (IN/OUT) - KCI environment handle initialized in object mode.
errhp (IN/OUT) -The KCI error handle. If there is an error, it is recorded in
errhp and this function returns KCI_ERROR. Diagnostic information can be
obtained by calling KCIErrorGet().
...
Name
KCI LOB FILE Is Open?

Purpose
Tests to see if the FILE is open

Syntax
sword KCILobFileIsOpen ( KCISvcCtx *p_svctx,
KCIError  *errhp,
KCILobLocator *filep,
boolean       *flag );
...
locator was never passed to KCILobFileOpen(), the file is considered not to
...
See also
KCIErrorGet, KCILobFileOpen, KCILobFileClose, KCILobFileCloseAll, CREATE
...
Syntax
sword KCILobFileOpen ( KCISvcCtx            *p_svctx,
KCIError             *errhp,
KCILobLocator        *filep,
ub1                  mode );
...
read-only - KCI_FILE_READONLY.

See Also
KCILobFileClose, KCIErrorGet, KCILobFileCloseAll, KCILobFileIsOpen,
KCILobFileSetName, CREATE DIRECTORY
...
Name
KCI Lob File Set NaMe

Purpose
Sets directory alias and file name in the FILE locator.

Syntax
sword KCILobFileSetName ( KCIEnv             *envhp,
KCIError           *errhp,
KCILobLocator      **filepp,
KunText               *dir_alias,
ub2                d_length,
KunText               *filename,
ub2                f_length );
...
See also
KCILobFileGetName, KCIErrorGet, CREATE DIRECTORY
...
Name
KCI Lob Flush all Buffers for this lob.
...
Syntax
sword KCILobFlushBuffer ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4              flag);
...
are assKCIated with the lob referenced by the input locator.  This
...
after a flush. Default value is KCI_LOB_BUFFER_NOFREE.
Set it to KCI_LOB_BUFFER_FREE if you want the buffer
...
Name
KCI Lob Free Temporary

Purpose
Free a temporary LOB

Syntax
sword KCILobFreeTemporary(KCISvcCtx          *p_svctx,
KCIError           *errhp,
KCILobLocator      *locp);

Comments
Frees the contents of the temporary Lob this locator is pointing to. Note
that the locator itself is not freed until a KCIDescriptorFree is done.
...
Syntax
sword KCILobGetChunkSize ( KCISvcCtx      *p_svctx,
KCIError       *errhp,
KCILobLocator  *locp,
ub4            *chunksizep );
...
specified by p_svctx. For FILEs, this locator can be initialized by a Select or
KCILobFileSetName.
...
Syntax
sword KCILobIsEqual ( KCIEnv                  *envhp,
const KCILobLocator     *x,
const KCILobLocator     *y,
boolean                 *is_equal );
...
Parameters
envhp (IN) - the KCI environment handle.
...
See also
KCILobAssign, KCILobLocatorIsInit
KCILobLocatorAssign,
KCILobIsOpen()
...
KCI Lob Is Open
sword KCILobIsOpen(p_svctx, errhp, locp, flag)
KCISvcCtx     *p_svctx;
KCIError      *errhp;
KCILobLocator *locp;
boolean       *flag;
...
KCI Lob Is Temporary

Purpose
Tests if this locator points to a temporary LOB

Syntax
sword KCILobIsTemporary(KCIEnv            *envhp,
KCIError          *errhp,
KCILobLocator     *locp,
...
See Also
KCILobCreateTemporary, KCILobFreeTemporary


KCILobLoadFromFile()

Name
KCI Lob Load From File

Purpose
Load/copy all or a portion of the file into an internal LOB.

Syntax
sword KCILobLoadFromFile ( KCISvcCtx        *p_svctx,
KCIError         *errhp,
KCILobLocator    *dst_locp,
KCILobLocator    *src_filep,
ub4              amount,
ub4              dst_offset,
ub4              src_offset );
...
See Also
KCIErrorGet(), KCILobAppend(), KCILobWrite(), KCILobTrim(), KCILobCopy()

KCILobLocatorAssign()

Name
KCI Lob LOCATOR ASsiGn

Purpose
Assigns one LOB/FILE locator to another.

Syntax
sword KCILobLocatorAssign ( KCISvcCtx             *p_svctx,
KCIError              *errhp,
const KCILobLocator   *src_locp,
KCILobLocator         **dst_locpp );
...
FILEs only the locator that refers to the OS file is copied to the table. The
OS file is not copied.
Note : the only difference between this and KCILobAssign is that this takes
a KCI service handle pointer instead of a KCI environment handle pointer

Parameters
p_svctx (IN/OUT) - KCI service handle initialized in object mode.
errhp (IN/OUT) - The KCI error handle. If there is an error, it is recorded
in errhp and this function returns KCI_ERROR. Diagnostic information can be
obtained by calling KCIErrorGet().
src_locp (IN) - LOB locator to copy from.
...
Name
KCI LOB locator is initialized?

Purpose
Tests to see if a given LOB locator is initialized.

Syntax
sword KCILobLocatorIsInit ( KCIEnv   *envhp,
KCIError *errhp,
const KCILobLocator *locp,
...
Syntax
sword KCILobRead ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4             offset,
ub4             *amtp,
...
Related Functions
KCIErrorGet, KCILobWrite, KCILobFileOpen, KCILobFileSetName, CREATE DIRECTORY
...
Syntax
sword KCILobTrim ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4             newlen );
...
must be a locator that was obtained from the server specified by p_svctx.
newlen (IN) - the new length of the LOB data, which must be less than or equal
to the current length.

Related Functions
KCIErrorGet, KCILobWrite, KCILobErase, KCILobAppend, KCILobCopy
...
Syntax
sword KCILobWrite ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4             offset,
ub4             *amtp,
...
Syntax
sword KCILobWriteAppend ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4             *amtp,
void           *bufp,
...
If no callback function is defined, then KCILobWriteAppend() returns the
KCI_NEED_DATA error code. The application must all KCILobWriteAppend() again
to write more pieces of the LOB. In this mode, the buffer pointer and the
length can be different in each call if the pieces are of different sizes and
from different locations. A piece value of KCI_LAST_PIECE terminates the
piecewise write.
...
Syntax
sword KCILobGetOptions ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4              optypes,
void            *optionsp,
...
Syntax
sword KCILobSetOptions ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
ub4              optypes,
void            *optionsp,
...
Name
KCI Lob Get Content Type

Purpose
To get the current contenttype set for the given SecureFile.

Syntax
sword KCILobGetContentType (KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
KunText         *contenttypep,
ub4             *contenttypelenp,
ub4              mode);
...
Comments
This function only works on SecureFiles.  All others will get an error.
If the securefile does not have a contenttype assKCIated with it,
...
be >= KCI_LOB_CONTENTTYPE_MAXSIZE bytes
...
Name
KCI Lob Set Content Type

Purpose
To set the contenttype for the given SecureFile Lob.

Syntax
sword KCILobSetContentType (KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCILobLocator   *locp,
const KunText   *contenttypep,
ub4              contenttypelen,
ub4              mode);
...
invoke KCILobSetContentType API with contenttypep  set to (KunText *)0,
...
contenttype should be <= KCI_LOB_CONTENTTYPE_MAXSIZE
bytes.
mode      (IN)     - for future use (pass 0 for now).
Related Functions
KCILobGetContentType()
...
KCILogoff()
Name
KCI simplified Logoff
Purpose
This function is used to terminate a session created with KCILogon() or
KCILogon2().
Syntax
sword KCILogoff ( KCISvcCtx      *p_svctx
KCIError       *errhp );
Comments
This call is used to terminate a session which was created with KCILogon() or
KCILogon2().
...
Parameters
p_svctx (IN) - the service context handle which was used in the call to
KCILogon() or KCILogon2().
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
See Also
KCILogon(), KCILogon2().
...
KCILogon()
Name
KCI Service Context Logon
Purpose
This function is used to create a simple logon session.
Syntax
sword KCILogon ( KCIEnv          *envhp,
KCIError        *errhp,
KCISvcCtx       *p_svctx,
const KunText      *username,
ub4             uname_len,
const KunText      *password,
ub4             passwd_len,
const KunText      *dbname,
ub4             dbname_len );
Comments
...
assKCIated with the session.  These handles can be retrieved by calling
KCIAttrGet() on the service context handle.
Parameters
envhp (IN) - the KCI environment handle.
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
p_svctx (OUT) - the service context pointer.
...
Connection Pooling mode. The valid values for mode are currently KCI_POOL and
KCI_DEFAULT. Call to this function with KCI_DEFAULT mode is equivalent to
KCILogon() call.
This call allocates the error and service context handles which are passed to
it. This call also implicitly allocates server and authentication handles
assKCIated with the session.  These handles can be retrieved by calling
KCIAttrGet() on the service context handle. This call assumes that
KCIConnectionPoolCreate() has already been called for the same dbname.
Parameters
envhp (IN) - the KCI environment handle.
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
...
dbname (IN) - the name of the database to connect to.
dbname_len (IN) - the length of dbname.
mode (IN) - the mode for doing the server attach. Should be KCI_POOL for
...
KCI FREE Memory
Purpose
Frees up storage assKCIated with the pointer.
Syntax
void KCIMemoryFree ( const KCIStmt   *stmhp,
void           *memptr);
Comments
Frees up dynamically allocated data pointers assKCIated with the pointer using
...
Syntax
sword KCIParamGet ( const void       *hndlp,
ub4         htype,
KCIError    *errhp,
void    **parmdpp,
ub4         pos );
...
allocated internally by the KCI library. They are read-only.
KCI_NO_DATA may be returned if there are no parameter descriptors for this
position.
See Appendix B for more detailed information about parameter descriptor
attributes.
Parameters
hndlp (IN) - a statement handle or describe handle. The KCIParamGet()
...
types are KCI_HTYPE_DESCRIBE, for a describe handle KCI_HTYPE_STMT, for a
statement handle
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
...
Note: KCI_NO_DATA may be returned if there are no parameter
descriptors for this position.
Related Functions
KCIAttrGet(), KCIAttrSet()
...
The handle must have been previously allocated using KCIHandleAlloc(), and
the descriptor must have been previously allocated using KCIDescAlloc().
Attributes of the descriptor are set using KCIAttrSet().
Parameters
...
KCIError      *errhp,
const KunText    *user_name,
ub4           usernm_len,
const KunText    *opasswd,
ub4           opasswd_len,
const KunText    *npasswd,
sb4           npasswd_len,
ub4           mode);
Comments
This call allows the password of an account to be changed. This call is
similar to KCISessionBegin() with the following differences:
...
KCISessionBegin() returns an error or warning which indicates that the
password has expired.
Parameters
p_svctx (IN/OUT) - a handle to a service context. The service context handle
must be initialized and have a server context handle assKCIated with it.
errhp (IN) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
...
if a KCIBreak call had been issued while a non-blocking operation was in
progress.
Syntax
sword KCIReset ( void      *hndlp,
KCIError   *errhp);
Comments
This call is called in non-blocking mode ONLY. Resets the interrupted
asynchronous operation and protocol. Must be called if a KCIBreak call
...
KCIResultSetToStmt()
Name
KCI convert Result Set to SQLSTMT Handle
Purpose
Converts a descriptor to statement handle for fetching rows.
Syntax
sword KCIResultSetToStmt ( KCIResult     *rsetdp,
KCIError      *errhp );
Comments
Converts a descriptor to statement handle for fetching rows.
A result set descriptor can be allocated with a call to KCIDescAlloc().
Parameters
...
KCIServerAttach()
Name
KCI ATtaCH to server
Purpose
Creates an access path to a data source for KCI operations.
Syntax
sword KCIServerAttach ( KCIServer    *p_srv,
KCIError     *errhp,
const KunText   *dblink,
sb4          dblink_len,
ub4          mode);
Comments
This call is used to create an assKCIation between an KCI application and a
particular server.
This call initializes a server context handle, which must have been previously
allocated with a call to KCIHandleAlloc().
The server context handle initialized by this call can be assKCIated with a
service context through a call to KCIAttrSet(). Once that assKCIation has been
made, KCI operations can be performed against the server.
If an application is operating against multiple servers, multiple server
context handles can be maintained. KCI operations are performed against
whichever server context is currently assKCIated with the service context.
Parameters
p_srv (IN/OUT) - an uninitialized server context handle, which gets
...
KCI_DEFAULT - in this mode, calls made to the server on this server context
are made in blocking mode.
Example
See the description of KCIStmtPrepare() on page 13-96 for an example showing
the use of KCIServerAttach().
Related Functions
KCIServerDetach()
...
KCI DeTaCH server
Purpose
Deletes an access to a data source for KCI operations.
Syntax
sword KCIServerDetach ( KCIServer   *svrhp,
KCIError    *errhp,
ub4         mode);
Comments
This call deletes an access to data source for KCI operations, which was
established by a call to KCIServerAttach().
Parameters
p_srv (IN) - a handle to an initialized server context, which gets reset to
...
KCI_DEFAULT for the default mode.
Related Functions
KCIServerAttach()
...
Syntax
sword KCIServerVersion ( void        *hndlp,
KCIError     *errhp,
KunText         *bufp,
ub4          bufsz
ub1          hndltype );
...
KCISessionBegin()
Name
KCI Session Begin and authenticate user
Purpose
Creates a user authentication and begins a user session for a given server.
Syntax
sword KCISessionBegin ( KCISvcCtx     *p_svctx,
KCIError      *errhp,
KCISession    *p_sess,
ub4           credt,
ub4           mode);
...
Comments
For Oracle8, KCISessionBegin() must be called for any given server handle
before requests can be made against it. Also, KCISessionBegin() only supports
authenticating the user for access to the Oracle server specified by the
server handle in the service context. In other words, after KCIServerAttach()
is called to initialize a server handle, KCISessionBegin() must be called to
authenticate the user for that given server.
When KCISessionBegin() is called for the first time for the given server
...
with the KCI_MIGRATE mode. Also, only one primary authentication context can
...
error will result.
After KCISessionBegin() has been called for the server handle, and the primary
authentication context is set in the service handle, KCISessionBegin() may be
called again to initialize another authentication handle with different (or
the same) credentials. When KCISessionBegin() is called with a service handle
...
User authentication contexts may be created with the KCI_MIGRATE mode.
If the KCI_MIGRATE mode is not specified, then the user authentication
context can only ever be used with the same server handle set in p_svctx. If
KCI_MIGRATE mode is specified, then the user authentication may be set
...
database user.
KCI_SYSDBA, KCI_SYSOPER, KCI_SYSASM, and KCI_PRELIM_AUTH may only be used
with a primary authentication context.
To provide credentials for a call to KCISessionBegin(), one of two methods are
...
KCISessionBegin(). This involves using KCIAttrSet() to set the
KCI_ATTR_USERNAME and KCI_ATTR_PASSWORD attributes on the
authentication handle. Then KCISessionBegin() is called with
KCI_CRED_RDBMS.
Note: When the authentication handle is terminated using
KCISessionEnd(), the username and password attributes remain
unchanged and thus can be re-used in a future call to KCISessionBegin().
Otherwise, they must be reset to new values before the next
KCISessionBegin() call.
...
KCISessionBegin(). The credential type is KCI_CRED_EXT. This is equivalent
to the Oracle7 `connect /' syntax. If values have been set for
KCI_ATTR_USERNAME and KCI_ATTR_PASSWORD, then these are
ignored if KCI_CRED_EXT is used.
Parameters
p_svctx (IN) - a handle to a service context. There must be a valid server
handle set in p_svctx.
errhp (IN) - an error handle to the retrieve diagnostic information.
p_sess (IN/OUT) - a handle to an authentication context, which is initialized
by this call.
credt (IN) - specifies the type of credentials to use for authentication.
Valid values for credt are:
KCI_CRED_RDBMS - authenticate using a database username and
password pair as credentials. The attributes KCI_ATTR_USERNAME
and KCI_ATTR_PASSWORD should be set on the authentication
context before this call.
KCI_CRED_EXT - authenticate using external credentials. No username
or password is provided.
mode (IN) - specifies the various modes of operation. Valid modes are:
KCI_DEFAULT - in this mode, the authentication context returned may
only ever be set with the same server context specified in p_svctx. This
establishes the primary authentication context.
KCI_MIGRATE - in this mode, the new authentication context may be
set in a service handle with a different server handle. This mode
establishes the user authentication context.
KCI_SYSDBA - in this mode, the user is authenticated for SYSDBA
access.
KCI_SYSOPER - in this mode, the user is authenticated for SYSOPER
access.
KCI_SYSASM - in this mode, the user is authenticated for SYSASM
access.  Note that only an ASM instance can grant SYSASM access.
KCI_PRELIM_AUTH - this mode may only be used with KCI_SYSDBA, KCI_SYSASM,
or KCI_SYSOPER to authenticate for certain administration tasks.
Related Functions
KCISessionEnd()
...
KCISessionEnd()
Name
KCI Terminate user Authentication Context
Purpose
Terminates a user authentication context created by KCISessionBegin()
Syntax
sword KCISessionEnd ( KCISvcCtx       *p_svctx,
KCIError        *errhp,
KCISession      *p_sess,
ub4             mode);

Comments
The user security context assKCIated with the service context is invalidated
...
The authentication handle may be reused in a new call to KCISessionBegin().
Parameters
p_svctx (IN/OUT) - the service context handle. There must be a valid server
handle and user authentication handle assKCIated with p_svctx.
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
p_sess (IN) - de-authenticate this user. If this parameter is passed as NULL,
the user in the service context handle is de-authenticated.
mode (IN) - the only valid mode is KCI_DEFAULT.
Example
...
KCI EXECute
Purpose
This call assKCIates an application request with a server.
Syntax
sword KCIStmtExecute ( KCISvcCtx           *p_svctx,
KCIStmt             *stmtp,
KCIError            *errhp,
ub4                 iters,
ub4                 rowoff,
const KCISnapshot   *snap_in,
KCISnapshot         *snap_out,
ub4                 mode );
Comments
This function  is used to execute a prepared SQL statement.
Using an execute call, the application assKCIates a request with a server. On
success, KCI_SUCCESS is returned.
...
call to KCIStmtExecute(), the number of rows specified by iters will be
...
Parameters
p_svctx (IN/OUT) - service context handle.
stmtp (IN/OUT) - an statement handle - defines the statement and the
assKCIated data to be executed at the server. It is invalid to pass in a
...
snapshot descriptor of type KCI_DTYPE_SNAP.  The contents of this descriptor
...
descriptor of type KCI_DTYPE_SNAP. This descriptor is filled in with an
opaque representation which is the current ORACLE "system change
number" suitable as a snap_in input to a subsequent call to KCIStmtExecute().
This descriptor should not be used any longer than necessary in order to avoid
"snapshot too old" errors.
mode (IN) - The modes are:
If KCI_DEFAULT_MODE, the default mode, is selected, the request is
immediately executed. Error handle contains diagnostics on error if any.
KCI_EXACT_FETCH - if the statement is a SQL SELECT, this mode is
only valid if the application has set the prefetch row count prior to this
call. In this mode, the KCI library will get up to the number of rows
specified (i.e., prefetch row count plus iters). If the number of rows
returned by the query is greater than this value, KCI_ERROR will be
...
smaller than the prefetch row count, KCI_SUCCESS_WITH_INFO will
be returned with ORA-01403 as the implementation specific error. The
prefetch buffer size is ignored and the KCI library tries to allocate all the
...
KCI_KEEP_FETCH_STATE - the result set rows (not yet fetched) of this
...
sword KCIStmtGetNextResult (KCIStmt *stmthp,
KCIError *errhp,
void **result,
ub4  *rtype,
ub4 mode)
...
mode     - (IN) KCI_DEFAULT for now

DESCRIPTION
Returns the implicit results from a executed PL/SQL statement
handle. Each call to KCIStmtGetNextResult () retrieves a single
implicit Result in the order in which they were returned from
the PL/SQL procedure/block. If no more Results are available,
then KCI_NO_DATA is returned. If rtype is KCI_RESULT_TYPE_SELECT, then
the returned result can be cast as an KCI statement handle.
The KCI statement handles for implicit result-sets
are allocated by KCI. Applications can do normal KCI define
and fetch calls to fetch rows from the implicit result-sets. The
returned KCI statement handle cannot be freed explicitly. All implicit
result-sets are automatically closed and freed when the top-level
statement handle is freed or released.
RETURN
KCI_ERROR
KCI_SUCCESS
KCI_NO_DATA  when all implicit ResultSets have been retrieved from
the top-level SQLSTMT handle
...
Syntax
sword KCIStmtFetch ( KCIStmt     *stmtp,
KCIError    *errhp,
ub4         nrows,
ub2         orientation,
ub4         mode);
...
KCI_FETCH_NEXT, which is also the default value.
mode (IN) - for release 8.0, beta-1, the following mode is defined.
KCI_DEFAULT - default mode
KCI_EOF_FETCH - indicates that it is the last fetch from the result set.
...
Fetches rows from a query.
Syntax
sword KCIStmtFetch2 ( KCIStmt     *stmtp,
KCIError    *errhp,
ub4         nrows,
ub2         orientation,
ub4         scrollOffset,
ub4         mode);
Comments
The fetch call works similar to the KCIStmtFetch call with the
...
will be KCI_FETCH_NEXT, and the fetchOffset parameter will be
ignored. Applications are encouraged to use this new call.

A fetchOffset with KCI_FETCH_RELATIVE is equivalent to
KCI_FETCH_CURRENT with a value of 0, is equivalent to
KCI_FETCH_NEXT with a value of 1, and equivalent to
KCI_FETCH_PRIOR with a value of -1. Note that the range of
accessible rows is [1,KCI_ATTR_ROW_COUNT] beyond which an
...
diagnostic information in the event of an error.
nrows (IN) - number of rows to be fetched from the current position.
It defaults to 1 for orientation KCI_FETCH_LAST.
...
KCIStmtGetPieceInfo()
Name
KCI Get Piece Information
Purpose
Returns piece information for a piecewise operation.
Syntax
sword KCIStmtGetPieceInfo( const KCIStmt  *stmtp,
KCIError       *errhp,
void          **hndlpp,
ub4            *typep,
ub1            *in_outp,
...
Comments
When an execute/fetch call returns KCI_NEED_DATA to get/return a
dynamic bind/define value or piece, KCIStmtGetPieceInfo() returns the
...
5-16 for more information about using KCIStmtGetPieceInfo().
Parameters
stmtp (IN) - the statement when executed returned KCI_NEED_DATA.
errhp (OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
...
typep (OUT) - the type of the handle pointed to by hndlpp: KCI_HTYPE_BIND
(for a bind handle) or KCI_HTYPE_DEFINE (for a define handle).
in_outp (OUT) - returns KCI_PARAM_IN if the data is required for an IN bind
value. Returns KCI_PARAM_OUT if the data is available as an OUT bind
...
KCI_ONE_PIECE, KCI_FIRST_PIECE, KCI_NEXT_PIECE and
KCI_LAST_PIECE. The default value is always KCI_ONE_PIECE.
Related Functions
KCIAttrGet(), KCIAttrGet(), KCIStmtExecute(), KCIStmtFetch(),
KCIStmtSetPieceInfo()
...
Syntax
sword KCIStmtPrepare ( KCIStmt      *stmtp,
KCIError     *errhp,
const KunText   *stmt,
ub4          stmt_len,
ub4          language,
...
KCIStmtPrepare() call defines an application request.
...
statement handle.
This call does not create an assKCIation between this statement handle and any
particular server.
...
string. The pointer to the KunText of the statement must be available as long
...
KCI_V7_SYNTAX - V7 ORACLE parsing syntax
KCI_V8_SYNTAX - V8 ORACLE parsing syntax
KCI_NTV_SYNTAX - syntax depending upon the version of the server.
mode (IN) - the only defined mode is KCI_DEFAULT for default mode.
Example
This example demonstrates the use of KCIStmtPrepare(), as well as the KCI
application initialization calls.
Related Functions
KCIAttrGet(), KCIStmtExecute()


KCIStmtPrepare2()
Name
KCI SQLSTMT REQuest with (a) early binding to p_svctx and/or
(b) stmt caching
Purpose
This call defines the SQL/PLSQL statement to be executed.
Syntax
sword KCIStmtPrepare2 ( KCISvcCtx *p_svctx,
KCIStmt      **stmtp,
KCIError     *errhp,
const KunText   *stmt,
ub4          stmt_len,
...
subsequent bind calls will be stored in a bind handle which will hang off this
statement handle.
This call creates an assKCIation between the statement handle and a service
context. It differs from KCIStmtPrepare in that respect.It also supports
stmt caching. The stmt will automatically be cached if the authp of the stmt
has enabled stmt caching.
Parameters
p_svctx (IN) - the service context handle that contains the session that
...
terminated string. The pointer to the KunText of the statement
must be available as long as the statement is executed.
stmt_len (IN) - length of the statement. Must not be zero.
key (IN) - This is only Valid for KCI Stmt Caching. It indicates the
...
KCI_V8_SYNTAX - V8 ORACLE parsing syntax
KCI_NTV_SYNTAX - syntax depending upon the version of the server.
mode (IN) - the defined modes are KCI_DEFAULT and KCI_PREP2_CACHE_SEARCHONLY.
Example
Related Functions
KCIStmtExecute(), KCIStmtRelease()


KCIStmtRelease()
Name
KCI SQLSTMT Release. This call is used to relesae the stmt that
was retreived using KCIStmtPrepare2(). If the stmt is release
using this call, KCIHandleFree() must not be called on the stmt
handle.
Purpose
This call releases the statement obtained by KCIStmtPrepare2
Syntax
sword KCIStmtRelease ( KCIStmt      *stmtp,
KCIError     *errhp,
cONST KunText *key,
ub4          key_len,
ub4          mode);
Comments
This call is used to release a handle obtained via KCIStmtPrepare2().
It also frees the memory assKCIated with the handle.
...
caching.
mode (IN) - the defined modes are KCI_DEFAULT for default mode and
KCI_STRLS_CACHE_DELETE (only used for Stmt Caching).
Example
Related Functions
KCIStmtExecute(), KCIStmtPrepare2()


KCIStmtSetPieceInfo()
Name
KCI Set Piece Information
Purpose
Sets piece information for a piecewise operation.
Syntax
sword KCIStmtSetPieceInfo ( void             *hndlp,
ub4               type,
KCIError          *errhp,
const void       *bufp,
ub4               *alenp,
...
ub2               *rcodep );
Comments
When an execute call returns KCI_NEED_DATA to get a dynamic IN/OUT
bind value or piece, KCIStmtSetPieceInfo() sets the piece information: the
buffer, the length, the indicator and which piece is currently being processed.
For more information about using KCIStmtSetPieceInfo() see the section
"Runtime Data Allocation and Piecewise Operations" on page 5-16.
Parameters
...
KCI_ONE_PIECE, KCI_FIRST_PIECE, KCI_NEXT_PIECE, or
KCI_LAST_PIECE.
The default value is KCI_ONE_PIECE. This parameter is used for IN bind
variables only.
...
KCIFormatInit
Name
KCIFormat Package Initialize
Purpose
Initializes the KCIFormat package.
Syntax
sword KCIFormatInit(void *hndl, KCIError *err);
Comments
This routine must be called before calling any other KCIFormat routine.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN/OUT) - KCI environment or session handle
err (IN/OUT) - KCI error handle
Related Functions
KCIFormatTerm()
...
KCIFormatString
Name
KCIFormat Package Format String
Purpose
...
Syntax
sword KCIFormatString(void *hndl, KCIError *err, KunText *buffer,
sbig_ora bufferLength, sbig_ora *returnLength,
const KunText *formatString, ...);
Comments
The first call to this routine must be preceded by a call to the
KCIFormatInit routine that initializes the KCIFormat package
for use.  When this routine is no longer needed then terminate
the KCIFormat package by a call to the KCIFormatTerm routine.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl         (IN/OUT) - KCI environment or session handle
err          (IN/OUT) - KCI error handle
...
KCIFormatTerm
Name
KCIFormat Package Terminate
Purpose
Terminates the KCIFormat package.
Syntax
sword KCIFormatTerm(void *hndl, KCIError *err);
Comments
It must be called after the KCIFormat package is no longer being used.
Returns KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
Parameters
hndl (IN/OUT) - KCI environment or session handle
err (IN/OUT) - KCI error handle
...
KCIFormatTUb1
Name
KCIFormat Package ub1 Type
Purpose
Return the type value for the ub1 type.
Syntax
sword KCIFormatTUb1(void);
Comments
None
Parameters
None
...
KCIFormatTUb2
Name
KCIFormat Package ub2 Type
Purpose
Return the type value for the ub2 type.
Syntax
sword KCIFormatTUb2(void);
Comments
None
Parameters
None
...
KCIFormatTUb4
Name
KCIFormat Package ub4 Type
Purpose
Return the type value for the ub4 type.
Syntax
sword KCIFormatTUb4(void);
Comments
None
Parameters
None
...
KCIFormatTUword
Name
KCIFormat Package uword Type
Purpose
Return the type value for the uword type.
Syntax
sword KCIFormatTUword(void);
Comments
None
Parameters
None
...
KCIFormatTUbig_ora
Name
KCIFormat Package ubig_ora Type
Purpose
Return the type value for the ubig_ora type.
Syntax
sword KCIFormatTUbig_ora(void);
Comments
None
Parameters
None
...
KCIFormatTSb1
Name
KCIFormat Package sb1 Type
Purpose
Return the type value for the sb1 type.
Syntax
sword KCIFormatTSb1(void);
Comments
None
Parameters
None
...
KCIFormatTSb2
Name
KCIFormat Package sb2 Type
Purpose
Return the type value for the sb2 type.
Syntax
sword KCIFormatTSb2(void);
Comments
None
Parameters
None
...
KCIFormatTSb4
Name
KCIFormat Package sb4 Type
Purpose
Return the type value for the sb4 type.
Syntax
sword KCIFormatTSb4(void);
Comments
None
Parameters
None
...
KCIFormatTSword
Name
KCIFormat Package sword Type
Purpose
Return the type value for the sword type.
Syntax
sword KCIFormatTSword(void);
Comments
None
Parameters
None
...
KCIFormatTSbig_ora
Name
KCIFormat Package sbig_ora Type
Purpose
Return the type value for the sbig_ora type.
Syntax
sword KCIFormatTSbig_ora(void);
Comments
None
Parameters
None
...
KCIFormatTEb1
Name
KCIFormat Package eb1 Type
Purpose
Return the type value for the eb1 type.
Syntax
sword KCIFormatTEb1(void);
Comments
None
Parameters
None
...
KCIFormatTEb2
Name
KCIFormat Package eb2 Type
Purpose
Return the type value for the eb2 type.
Syntax
sword KCIFormatTEb2(void);
Comments
None
Parameters
None
...
KCIFormatTEb4
Name
KCIFormat Package eb4 Type
Purpose
Return the type value for the eb4 type.
Syntax
sword KCIFormatTEb4(void);
Comments
None
Parameters
None
...
KCIFormatTEword
Name
KCIFormat Package eword Type
Purpose
Return the type value for the eword type.
Syntax
sword KCIFormatTEword(void);
Comments
None
Parameters
None
...
KCIFormatTChar
Name
KCIFormat Package text Type
Purpose
Return the type value for the text type.
Syntax
sword KCIFormatTChar(void);
Comments
None
Parameters
None
...
KCIFormatTDouble
Name
KCIFormat Package double Type
Purpose
Return the type value for the double type.
Syntax
sword KCIFormatTDouble(void);
Comments
None
Parameters
None
...
KCIFormatDvoid
Name
KCIFormat Package void Type
Purpose
Return the type value for the void type.
Syntax
sword KCIFormatTDvoid(void);
Comments
None
Parameters
None
...
KCIFormatTEnd
Name
KCIFormat Package end Type
Purpose
Return the list terminator's "type".
Syntax
sword KCIFormatTEnd(void);
Comments
None
Parameters
None
...
KCISvcCtxToLda()
Name
KCI toggle SerVice context handle to Version 7 Lda_Def
Purpose
Toggles between a V8 service context handle and a V7 Lda_Def.
Syntax
sword KCISvcCtxToLda ( KCISvcCtx    *p_srv,
KCIError     *errhp,
Lda_Def      *ldap );
Comments
...
release 7.x KCI calls (e.g., obindps(), ofen()).
...
the KCILdaToSvcCtx() function.
Parameters
p_svctx (IN/OUT) - the service context handle.
errhp (IN/OUT) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
ldap (IN/OUT) - a Logon Data Area for V7-style KCI calls which is initialized
by this call.
Related Functions
KCILdaToSvcCtx()
...
KCITransCommit()
Name
KCI TX (transaction) CoMmit
Purpose
Commits the transaction assKCIated with a specified service context.
Syntax
sword KCITransCommit ( KCISvcCtx    *srvcp,
KCIError     *errhp,
ub4          flags );
Comments
The transaction currently assKCIated with the service context is committed. If
...
on the transaction currently assKCIated with the service context. If the
...
KCITransDetach()
Name
KCI TX (transaction) DeTach
Purpose
Detaches a transaction.
Syntax
sword KCITransDetach ( KCISvcCtx    *srvcp,
KCIError     *errhp,
ub4          flags);
Comments
...
errhp (IN) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
flags (IN) - you must pass a value of KCI_DEFAULT for this parameter.
Related Functions
KCITransStart()
...
errhp (IN) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
flags (IN) - you must pass KCI_DEFAULT for this parameter.
Related Functions
KCITransCommit(), KCITransRollback()


KCITransMultiPrepare()
Name
KCI Trans(action) Multi-Branch Prepare
Purpose
Prepares a transaction with multiple branches in a single call.
Syntax
sword KCITransMultiPrepare ( KCISvcCtx    *p_svctx,
ub4           numBranches,
KCITrans     **txns,
KCIError     **errhp);
...
prepare. They should all have the KCI_ATTR_XID set. The global transaction
ID should be the same.
errhp (IN) - This is the array of error handles. If KCI_SUCCESS is not
...
KCITransPrepare()
Name
KCI TX (transaction) PREpare
Purpose
Prepares a transaction for commit.
Syntax
sword KCITransPrepare ( KCISvcCtx    *p_svctx,
KCIError     *errhp,
ub4          flags);
...
KCITransRollback()
Name
KCI TX (transaction) RoLlback
Purpose
Rolls back the current transaction.
Syntax
sword KCITransRollback ( void        *p_svctx,
KCIError     *errhp,
ub4          flags );
Comments
...
Parameters
p_svctx (IN) - a service context handle. The transaction currently set in the
service context handle is rolled back.
errhp -(IN) - an error handle which can be passed to KCIErrorGet() for
diagnostic information in the event of an error.
flags - you must pass a value of KCI_DEFAULT for this parameter.
Related Functions
KCITransCommit()
...
KCITransStart()
Name
KCI TX (transaction) STart
Purpose
Sets the beginning of a transaction.
Syntax
sword KCITransStart ( KCISvcCtx    *p_svctx,
KCIError     *errhp,
uword        timeout,
ub4          flags);
...
transaction context currently assKCIated with the service context handle is
...
(KCI_ATTR_XID)
Parameters
p_svctx (IN/OUT) - the service context handle. The transaction context in the
service context handle is initialized at the end of the call if the flag
specified a new transaction to be started.
errhp (IN/OUT) - The KCI error handle. If there is an error, it is recorded in
err and this function returns KCI_ERROR. Diagnostic information can be
obtained by calling KCIErrorGet().
timeout (IN) - the time, in seconds, to wait for a transaction to become
available for resumption when KCI_TRANS_RESUME is specified. When
KCI_TRANS_NEW is specified, this value is stored and may be used later by
KCITransDetach().
...
KCI_TRANS_NEW - starts a new transaction branch. By default starts a
tightly coupled and migratable branch.
KCI_TRANS_TIGHT - explicitly specifies a tightly coupled branch
KCI_TRANS_LOOSE - specifies a loosely coupled branch
KCI_TRANS_RESUME - resumes an existing transaction branch.
KCI_TRANS_READONLY - start a readonly transaction
KCI_TRANS_SERIALIZABLE - start a serializable transaction
Related Functions
KCITransDetach()
...
typedef sb4(*KCICallbackInBind)(void  *ictxp, KCIBind *bindp, ub4 iter,
	ub4 index, void  **bufpp, ub4 *alenp,
	ub1 *piecep, void  **indp);

typedef sb4(*KCICallbackOutBind)(void  *octxp, KCIBind *bindp, ub4 iter,
	ub4 index, void  **bufpp, ub4 **alenp,
	ub1 *piecep, void  **indp,
	ub2 **rcodep);

typedef sb4(*KCICallbackDefine)(void  *octxp, KCIDefine *defnp, ub4 iter,
	void  **bufpp, ub4 **alenp, ub1 *piecep,
	void  **indp, ub2 **rcodep);

typedef sword(*KCIUserCallback)(void  *ctxp, void  *hndlp, ub4 type,
	ub4 fcode, ub4 when, sword returnCode,
	sb4 *errnop, va_list arglist);

typedef sword(*KCIEnvCallbackType)(KCIEnv *env, ub4 mode,
	size_t xtramem_sz, void  *usrmemp,
	KCIUcb *ucbDesc);

typedef sb4(*KCICallbackLobRead)(void  *ctxp, const void  *bufp,
	ub4 len, ub1 piece);

typedef sb4(*KCICallbackLobWrite)(void  *ctxp, void  *bufp,
	ub4 *lenp, ub1 *piece);

#ifdef ORAXB8_DEFINED

typedef sb4(*KCICallbackLobRead2)(void  *ctxp, const void  *bufp, oraub8 len,
	ub1 piece, void  **changed_bufpp,
	oraub8 *changed_lenp);

typedef sb4(*KCICallbackLobWrite2)(void  *ctxp, void  *bufp, oraub8 *lenp,
	ub1 *piece, void  **changed_bufpp,
	oraub8 *changed_lenp);

typedef sb4(*KCICallbackLobArrayRead)(void  *ctxp, ub4 array_iter,
	const void  *bufp, oraub8 len,
	ub1 piece, void  **changed_bufpp,
	oraub8 *changed_lenp);

typedef sb4(*KCICallbackLobArrayWrite)(void  *ctxp, ub4 array_iter,
	void  *bufp, oraub8 *lenp,
	ub1 *piece, void  **changed_bufpp,
	oraub8 *changed_lenp);
#endif

typedef sb4(*KCICallbackLobGetDeduplicateRegions)(void *ctxp,
	KCILobRegion *regions,
	ub4 count, ub1 piece,
	KCILobRegion **changed_reg,
	ub4 *changed_count);

typedef sb4(*KCICallbackAQEnq)(void  *ctxp, void  **payload,
	void  **payload_ind);

/*
typedef sb4(*KCICallbackAQEnqStreaming)(void  *ctxp, void  **payload,
	void  **payload_ind,
	KCIAQMsgProperties  **msgprop,
	KCIType **tdo);
*/
typedef sb4(*KCICallbackAQDeq)(void  *ctxp, void  **payload,
	void  **payload_ind);

/*--------------------------Failover Callback Structure ---------------------*/
typedef sb4(*KCICallbackFailover)(void  *p_svctx, void  *envctx,
	void  *fo_ctx, ub4 fo_type,
	ub4 fo_event);

typedef struct
{
	KCICallbackFailover callback_function;
	void  *fo_ctx;
}
KCIFocbkStruct;

/*---------------------SQLSTMT Cache callback function ------------------*/

typedef sword(*KCICallbackStmtCache)(void *ctx, KCIStmt *stmt, ub4 mode);

/*--------------------------HA Callback Structure ---------------------*/
typedef void(*KCIEventCallback)(void  *evtctx, KCIEvent *eventhp);


/*------------------------- Round Trip Callback Structure --------------------*/
typedef sword(*KCIRoundTripCallback)(void  *rtctx, KCISvcCtx *svch,
	KCISession *userh);
...
sword   KCIHandleAlloc(const void  *parenth, void  **hndlpp, const ub4 type,
...
sword   KCIServerAttach(KCIServer *p_srv, KCIError *errhp,
	const KunText *dblink, sb4 dblink_len, ub4 mode);

sword   KCIServerDetach(KCIServer *p_srv, KCIError *errhp, ub4 mode);

sword   KCISessionBegin(KCISvcCtx *p_svctx, KCIError *errhp, KCISession *p_sess,
	ub4 credt, ub4 mode);

sword   KCISessionEnd(KCISvcCtx *p_svctx, KCIError *errhp, KCISession *p_sess,
	ub4 mode);

sword   KCILogon(KCIEnv *envhp, KCIError *errhp, KCISvcCtx **p_svctx,
	const KunText *username, ub4 uname_len,
	const KunText *password, ub4 passwd_len,
	const KunText *dbname, ub4 dbname_len);

sword   KCILogon2(KCIEnv *envhp, KCIError *errhp, KCISvcCtx **p_svctx,
	const KunText *username, ub4 uname_len,
	const KunText *password, ub4 passwd_len,
	const KunText *dbname, ub4 dbname_len,
	ub4 mode);
...
sword   KCIPasswordChange(KCISvcCtx *p_svctx, KCIError *errhp,
	const KunText *user_name, ub4 usernm_len,
	const KunText *opasswd, ub4 opasswd_len,
	const KunText *npasswd, ub4 npasswd_len,
	ub4 mode);

sword   KCIStmtPrepare(KCIStmt *stmtp, KCIError *errhp, const KunText *stmt,
	ub4 stmt_len, ub4 language, ub4 mode);

sword KCIStmtPrepare2(KCISvcCtx *p_svctx, KCIStmt **stmtp, KCIError *errhp,
	const KunText *stmt, ub4 stmt_len, const KunText *key,
	ub4 key_len, ub4 language, ub4 mode);

sword KCIStmtRelease(KCIStmt *stmtp, KCIError *errhp, const KunText *key,
	ub4 key_len, ub4 mode);

sword KCIStmtPartFree(KCIStmt *stmtp, ub2 option);

sword   KCIBindByPos(KCIStmt *stmtp, KCIBind **bindp, KCIError *errhp,
	ub4 position, void  *valuep, sb4 value_sz,
	ub2 dty, void  *indp, ub2 *alenp, ub2 *rcodep,
	ub4 maxarr_len, ub4 *curelep, ub4 mode);

sword   KCIBindByPos2(KCIStmt *stmtp, KCIBind **bindp, KCIError *errhp,
	ub4 position, void  *valuep, sb8 value_sz,
	ub2 dty, void  *indp, ub4 *alenp, ub2 *rcodep,
	ub4 maxarr_len, ub4 *curelep, ub4 mode);

sword   KCIBindByName(KCIStmt *stmtp, KCIBind **bindp, KCIError *errhp,
	const KunText *placeholder, sb4 placeh_len,
	void  *valuep, sb4 value_sz, ub2 dty,
	void  *indp, ub2 *alenp, ub2 *rcodep,
	ub4 maxarr_len, ub4 *curelep, ub4 mode);

sword   KCIBindByName2(KCIStmt *stmtp, KCIBind **bindp, KCIError *errhp,
	const KunText *placeholder, sb4 placeh_len,
...
sword   KCIBindDynamic(KCIBind *bindp, KCIError *errhp, void  *ictxp,
	KCICallbackInBind icbfp, void  *octxp,
	KCICallbackOutBind ocbfp);
...
sword   KCIStmtSetPieceInfo(void  *hndlp, ub4 type, KCIError *errhp,
	const void  *bufp, ub4 *alenp, ub1 piece,
	const void  *indp, ub2 *rcodep);

sword   KCIStmtExecute(KCISvcCtx *p_svctx, KCIStmt *stmtp, KCIError *errhp,
	ub4 iters, ub4 rowoff, const KCISnapshot *snap_in,
...
sword   KCIDefineObject(KCIDefine *defnp, KCIError *errhp,
	const KCIType *type, void  **pgvpp,
	ub4 *pvszsp, void  **indpp, ub4 *indszp);
*/
sword   KCIDefineDynamic(KCIDefine *defnp, KCIError *errhp, void  *octxp,
	KCICallbackDefine ocbfp);

sword   KCIRowidToChar(KCIRowid *rowidDesc, KunText *outbfp, ub2 *outbflp,
	KCIError *errhp);
...
sword   KCIStmtFetchOutParams(KCIStmt *stmtp, int iters, KCIError *errhp);
sword   KCIStmtFetchReturning(KCIStmt *stmtp, int iters, KCIError *errhp);
int   toSysData(int kun_dt, void *kun_dat, int kun_siz, int val_dt, char *val_ptr, int var_size);

sword   KCIStmtGetBindInfo(KCIStmt *stmtp, KCIError *errhp, ub4 size,
	ub4 startloc,
	sb4 *found, KunText *bvnp[], ub1 bvnl[],
	KunText *invp[], ub1 inpl[], ub1 dupl[],
	KCIBind **hndl);

sword   KCIDescribeAny(KCISvcCtx *p_svctx, KCIError *errhp,
	void  *objptr,
	ub4 objnm_len, ub1 objptr_typ, ub1 info_level,
	ub1 objtyp, KCIDescribe *dschp);

sword   KCIParamGet(const void  *hndlp, ub4 htype, KCIError *errhp,
	void  **parmdpp, ub4 pos);

sword   KCIParamSet(void  *hdlp, ub4 htyp, KCIError *errhp, const void  *dscp,
	ub4 dtyp, ub4 pos);
...
sword   KCIErrorGet(void  *hndlp, ub4 recordno, KunText *sqlstate,
	sb4 *errcodep, KunText *bufp, ub4 bufsiz, ub4 type);

sword   KCILobAppend(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *dst_locp,
	KCILobLocator *src_locp);

sword   KCILobAssign(KCIEnv *envhp, KCIError *errhp,
	const KCILobLocator *src_locp,
	KCILobLocator **dst_locpp);

sword   KCILobCharSetForm(KCIEnv *envhp, KCIError *errhp,
	const KCILobLocator *locp, ub1 *csfrm);

sword   KCILobCharSetId(KCIEnv *envhp, KCIError *errhp,
	const KCILobLocator *locp, ub2 *csid);

sword   KCILobCopy(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *dst_locp,
	KCILobLocator *src_locp, ub4 amount, ub4 dst_offset,
	ub4 src_offset);
...
sword   KCILobErase(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *locp,
	ub4 *amount, ub4 offset);

sword   KCILobFileClose(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *filep);

sword   KCILobFileCloseAll(KCISvcCtx *p_svctx, KCIError *errhp);

sword   KCILobFileExists(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *filep,
	boolean *flag);

sword   KCILobFileGetName(KCIEnv *envhp, KCIError *errhp,
	const KCILobLocator *filep,
	KunText *dir_alias, ub2 *d_length,
	KunText *filename, ub2 *f_length);

sword   KCILobFileIsOpen(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *filep,
	boolean *flag);

sword   KCILobFileOpen(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *filep,
	ub1 mode);

sword   KCILobFileSetName(KCIEnv *envhp, KCIError *errhp,
	KCILobLocator **filepp,
	const KunText *dir_alias, ub2 d_length,
	const KunText *filename, ub2 f_length);
...
sword   KCILobGetLength(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *locp,
	ub4 *lenp);

sword   KCILobIsEqual(KCIEnv *envhp, const KCILobLocator *x,
	const KCILobLocator *y,
	boolean *is_equal);

sword KCILobIsOpen(KCISvcCtx     *p_svctx,
	KCIError      *errhp,
	KCILobLocator *locp,
	boolean       *flag);

sword KCILobIsTemporary(KCIEnv            *envp,
	KCIError          *errhp,
	KCILobLocator     *locp,
	boolean           *is_temporary);

sword   KCILobLoadFromFile(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *dst_locp,
	KCILobLocator *src_filep,
	ub4 amount, ub4 dst_offset,
	ub4 src_offset);

sword   KCILobLocatorAssign(KCISvcCtx *p_svctx, KCIError *errhp,
	const KCILobLocator *src_locp,
	KCILobLocator **dst_locpp);


sword   KCILobLocatorIsInit(KCIEnv *envhp, KCIError *errhp,
	const KCILobLocator *locp,
	boolean *is_initialized);
...
sword   KCILobTrim(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *locp,
	ub4 newlen);

sword   KCILobWrite(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *locp,
	ub4 *amtp, ub4 offset, void  *bufp, ub4 buflen,
	ub1 piece, void  *ctxp, KCICallbackLobWrite cbfp,
	ub2 csid, ub1 csfrm);

sword KCILobGetDeduplicateRegions(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *locp,
	KCILobRegion *regp, ub4 *count, ub1 piece,
	void *ctxp,
	KCICallbackLobGetDeduplicateRegions cbfp);

sword KCILobWriteAppend(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *lobp,
	ub4 *amtp, void  *bufp, ub4 bufl, ub1 piece,
	void *ctxp, KCICallbackLobWrite cbfp, ub2 csid,
	ub1 csfrm);

sword   KCIBreak(void  *hndlp, KCIError *errhp);

sword   KCIReset(void  *hndlp, KCIError *errhp);

sword   KCIServerVersion(void  *hndlp, KCIError *errhp, KunText *bufp,
	ub4 bufsz,
	ub1 hndltype);

sword   KCIServerRelease(void  *hndlp, KCIError *errhp, KunText *bufp,
	ub4 bufsz,
...
sword   KCIAttrSet(void  *trgthndlp, ub4 trghndltyp, void  *attributep,
	ub4 size, ub4 attrtype, KCIError *errhp);

/*
sword   KCISvcCtxToLda(KCISvcCtx *p_svctx, KCIError *errhp, Lda_Def *ldap);

sword   KCILdaToSvcCtx(KCISvcCtx **svchpp, KCIError *errhp, Lda_Def *ldap);
*/
sword   KCIResultSetToStmt(KCIResult *rsetdp, KCIError *errhp);

//sword KCIFileClose(void   *hndl, KCIError *err, KCIFileObject *filep);

sword   KCIUserCallbackRegister(void  *hndlp, ub4 type, void  *ehndlp,
	KCIUserCallback callback, void  *ctxp,
	ub4 fcode, ub4 when, KCIUcb *ucbDesc);

sword   KCIUserCallbackGet(void  *hndlp, ub4 type, void  *ehndlp,
	ub4 fcode, ub4 when, KCIUserCallback *callbackp,
	void  **ctxpp, KCIUcb *ucbDesc);

sword   KCISharedLibInit(void  *metaCtx, void  *libCtx, ub4 argfmt, sword argc,
	void  **argv, KCIEnvCallbackType envCallback);

/*
sword KCIFileExists(void   *hndl, KCIError *err, KunText *filename,
	KunText *path, ub1 *flag);

sword KCIFileFlush(void  *hndl, KCIError *err, KCIFileObject *filep);


sword KCIFileGetLength(void  *hndl, KCIError *err, KunText *filename,
	KunText *path, ubig_ora *lenp);

sword KCIFileInit(void  *hndl, KCIError *err);

sword KCIFileOpen(void  *hndl, KCIError *err, KCIFileObject **filep,
	KunText *filename, KunText *path, ub4 mode, ub4 create,
	ub4 type);

sword KCIFileRead(void  *hndl, KCIError *err, KCIFileObject *filep,
	void  *bufp, ub4 bufl, ub4 *bytesread);

sword KCIFileSeek(void  *hndl, KCIError *err, KCIFileObject *filep,
	uword origin, ubig_ora offset, sb1 dir);

sword KCIFileTerm(void  *hndl, KCIError *err);


sword KCIFileWrite(void  *hndl, KCIError *err, KCIFileObject   *filep,
	void  *bufp, ub4 buflen, ub4 *byteswritten);
	*/

#ifdef ORAXB8_DEFINED

sword   KCILobCopy2(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *dst_locp,
	KCILobLocator *src_locp, oraub8 amount,
	oraub8 dst_offset,
	oraub8 src_offset);

sword   KCILobErase2(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *locp,
	oraub8 *amount, oraub8 offset);

sword   KCILobGetLength2(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *locp, oraub8 *lenp);

sword   KCILobLoadFromFile2(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *dst_locp,
	KCILobLocator *src_filep,
	oraub8 amount, oraub8 dst_offset,
	oraub8 src_offset);

sword   KCILobRead2(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *locp,
	oraub8 *byte_amtp, oraub8 *char_amtp, oraub8 offset,
	void  *bufp, oraub8 bufl, ub1 piece, void  *ctxp,
	KCICallbackLobRead2 cbfp, ub2 csid, ub1 csfrm);

sword   KCILobArrayRead(KCISvcCtx *p_svctx, KCIError *errhp, ub4 *array_iter,
	KCILobLocator **lobp_arr, oraub8 *byte_amt_arr,
	oraub8 *char_amt_arr, oraub8 *offset_arr,
	void  **bufp_arr, oraub8 *bufl_arr, ub1 piece,
	void  *ctxp, KCICallbackLobArrayRead cbfp, ub2 csid,
	ub1 csfrm);

sword   KCILobTrim2(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *locp,
	oraub8 newlen);

sword   KCILobWrite2(KCISvcCtx *p_svctx, KCIError *errhp, KCILobLocator *locp,
	oraub8 *byte_amtp, oraub8 *char_amtp, oraub8 offset,
	void  *bufp, oraub8 buflen, ub1 piece, void  *ctxp,
	KCICallbackLobWrite2 cbfp, ub2 csid, ub1 csfrm);

sword   KCILobArrayWrite(KCISvcCtx *p_svctx, KCIError *errhp, ub4 *array_iter,
	KCILobLocator **lobp_arr, oraub8 *byte_amt_arr,
	oraub8 *char_amt_arr, oraub8 *offset_arr,
	void  **bufp_arr, oraub8 *bufl_arr, ub1 piece,
	void  *ctxp, KCICallbackLobArrayWrite cbfp, ub2 csid,
	ub1 csfrm);

sword KCILobWriteAppend2(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *lobp,
	oraub8 *byte_amtp, oraub8 *char_amtp, void  *bufp,
	oraub8 bufl, ub1 piece, void  *ctxp,
	KCICallbackLobWrite2 cbfp, ub2 csid, ub1 csfrm);

sword KCILobGetStorageLimit(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *lobp, oraub8 *limitp);

sword KCILobGetOptions(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *lobp,
	ub4 optypes, void *optionsp, ub4 *optionslenp,
	ub4 mode);

sword KCILobSetOptions(KCISvcCtx *p_svctx, KCIError *errhp,
	KCILobLocator *lobp,
	ub4 optypes, void *optionsp, ub4 optionslen,
	ub4 mode);

sword KCILobGetContentType(KCISvcCtx *p_svctx,
	KCIError *errhp, KCILobLocator *lobp,
	KunText *contenttypep, ub4 *contenttypelenp,
	ub4 mode);

sword KCILobSetContentType(KCISvcCtx *p_svctx,
	KCIError *errhp, KCILobLocator *lobp,
	const KunText *contenttypep, ub4 contenttypelen,
	ub4 mode);
...
*/
sword   KCISecurityInitialize(KCISecurity *sechandle, KCIError *error_handle);

sword   KCISecurityTerminate(KCISecurity *sechandle, KCIError *error_handle);

/*
sword KCISecurityOpenWallet(KCISecurity *osshandle,
	KCIError *error_handle,
	size_t wrllen,
	KunText *wallet_resource_locator,
	size_t pwdlen,
	KunText *password,
	nzttWallet *wallet);

sword KCISecurityCloseWallet(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttWallet *wallet);

sword KCISecurityCreateWallet(KCISecurity *osshandle,
	KCIError *error_handle,
	size_t wrllen,
	KunText *wallet_resource_locator,
	size_t pwdlen,
...
sword KCISecurityDestroyWallet(KCISecurity *osshandle,
	KCIError *error_handle,
	size_t wrllen,
	KunText *wallet_resource_locator,
	size_t pwdlen,
...
sword KCISecurityStorePersona(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona **persona,
	nzttWallet *wallet);

sword KCISecurityOpenPersona(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona);

sword KCISecurityClosePersona(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona);

sword KCISecurityRemovePersona(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona **persona);

sword KCISecurityCreatePersona(KCISecurity *osshandle,
	KCIError *error_handle,
...
sword KCISecuritySetProtection(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
...
sword KCISecurityGetProtection(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttcef crypto_engine_function,
...
sword KCISecurityRemoveIdentity(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttIdentity **identity_ptr);

sword KCISecurityCreateIdentity(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttIdentType type,
	nzttIdentityDesc *desc,
	nzttIdentity **identity_ptr);

sword KCISecurityAbortIdentity(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttIdentity **identity_ptr);

sword KCISecurityFreeIdentity(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttIdentity **identity_ptr);


sword KCISecurityStoreTrustedIdentity(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttIdentity **identity_ptr,
	nzttPersona *persona);

sword KCISecuritySign(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
...
sword KCISecuritySignExpansion(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t inputlen,
	size_t *signature_length);

sword KCISecurityVerify(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces signature_state,
	size_t siglen,
...
sword KCISecurityValidate(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttIdentity *identity,
	boolean *validated);

sword KCISecuritySignDetached(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces signature_state,
	size_t input_length,
...
sword KCISecuritySignDetExpansion(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t input_length,
	size_t *required_buffer_length);

sword KCISecurityVerifyDetached(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces signature_state,
	size_t data_length,
...
sword KCISecurity_PKEncrypt(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
...
sword KCISecurityPKEncryptExpansion(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
...
sword KCISecurityPKDecrypt(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces encryption_state,
	size_t input_length,
...
sword KCISecurityEncrypt(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces encryption_state,
	size_t input_length,
...
sword KCISecurityEncryptExpansion(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t input_length,
	size_t *encrypted_data_length);

sword KCISecurityDecrypt(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
...
sword KCISecurityEnvelope(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t number_of_recipients,
	nzttIdentity *identity,
...
sword KCISecurityDeEnvelope(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces decryption_state,
	size_t input_length,
...
sword KCISecurityKeyedHash(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces hash_state,
	size_t input_length,
...
sword KCISecurityKeyedHashExpansion(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t input_length,
	size_t *required_buffer_length);

sword KCISecurityHash(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	nzttces hash_state,
	size_t input,
...
sword KCISecurityHashExpansion(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t input_length,
	size_t *required_buffer_length);

sword KCISecuritySeedRandom(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t seed_length,
	ub1 *seed);

sword KCISecurityRandomBytes(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	size_t number_of_bytes_desired,
	nzttBufferBlock *random_bytes);

sword KCISecurityRandomNumber(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttPersona *persona,
	uword *random_number_ptr);

sword KCISecurityInitBlock(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttBufferBlock *buffer_block);

sword KCISecurityReuseBlock(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttBufferBlock *buffer_block);

sword KCISecurityPurgeBlock(KCISecurity *osshandle,
	KCIError *error_handle,
	nzttBufferBlock *buffer_block);

sword KCISecuritySetBlock(KCISecurity *osshandle,
	KCIError *error_handle,
	uword flags_to_set,
...
sword KCISecurityGetIdentity(KCISecurity   *osshandle,
	KCIError      *error_handle,
	size_t         namelen,
	KunText          *distinguished_name,
	nzttIdentity **identity);

sword KCIAQEnq(KCISvcCtx *p_svctx, KCIError *errhp, KunText *queue_name,
	KCIAQEnqOptions *enqopt, KCIAQMsgProperties *msgprop,
	KCIType *payload_tdo, void  **payload, void  **payload_ind,
	KCIRaw **msgid, ub4 flags);

sword KCIAQDeq(KCISvcCtx *p_svctx, KCIError *errhp, KunText *queue_name,
	KCIAQDeqOptions *deqopt, KCIAQMsgProperties *msgprop,
	KCIType *payload_tdo, void  **payload, void  **payload_ind,
	KCIRaw **msgid, ub4 flags);

sword KCIAQEnqArray(KCISvcCtx *p_svctx, KCIError *errhp, KunText *queue_name,
	KCIAQEnqOptions *enqopt, ub4 *iters,
	KCIAQMsgProperties **msgprop, KCIType *payload_tdo,
	void  **payload, void  **payload_ind, KCIRaw **msgid,
	void  *ctxp, KCICallbackAQEnq enqcbfp, ub4 flags);

sword KCIAQEnqStreaming(KCISvcCtx *p_svctx, KCIError *errhp, KunText *queue_name,
	KCIAQEnqOptions *enqopt, KCIType *payload_tdo,
	void  *ctxp, KCICallbackAQEnqStreaming enqcbfp,
	ub4 flags);

sword KCIAQDeqArray(KCISvcCtx *p_svctx, KCIError *errhp, KunText *queue_name,
	KCIAQDeqOptions *deqopt, ub4 *iters,
	KCIAQMsgProperties **msgprop, KCIType *payload_tdo,
	void  **payload, void  **payload_ind, KCIRaw **msgid,
	void  *ctxp, KCICallbackAQDeq deqcbfp, ub4 flags);

sword KCIAQListen(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAQAgent **agent_list, ub4 num_agents,
	sb4 wait, KCIAQAgent **agent,
	ub4 flags);

sword KCIAQListen2(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAQAgent **agent_list, ub4 num_agents,
	KCIAQListenOpts  *lopts, KCIAQAgent **agent,
	KCIAQLisMsgProps *lmops, ub4 flags);

sword KCIAQGetReplayInfo(KCISvcCtx *p_svctx, KCIError *errhp,
	KunText *queue_name, KCIAQAgent *sender,
	ub4 replay_attribute, KunText *correlation,
	ub2 *corr_len);

sword KCIAQResetReplayInfo(KCISvcCtx *p_svctx, KCIError *errhp,
	KunText *queue_name, KCIAQAgent *sender,
...
sword KCIMemoryAlloc(void  *hdl, KCIError *err, void  **mem,
	KCIDuration dur, ub4 size, ub4 flags);

sword KCIMemoryResize(void  *hdl, KCIError *err, void  **mem,
	ub4 newsize, ub4 flags);

sword KCIMemoryFree(void  *hdl, KCIError *err, void  *mem);

sword KCIContextSetValue(void  *hdl, KCIError *err, KCIDuration duration,
	ub1 *key, ub1 keylen, void  *ctx_value);

sword KCIContextGetValue(void  *hdl, KCIError *err, ub1 *key,
	ub1 keylen, void  **ctx_value);

sword KCIContextClearValue(void  *hdl, KCIError *err, ub1 *key,
	ub1 keylen);

sword KCIContextGenerateKey(void  *hdl, KCIError *err, ub4 *key);

sword KCIMemorySetCurrentIDs(void  *hdl, KCIError *err,
	ub4 curr_session_id, ub4 curr_trans_id,
	ub4 curr_stmt_id);

sword KCIPicklerTdsCtxInit(KCIEnv *env, KCIError *err,
	KCIPicklerTdsCtx **tdsc);

sword KCIPicklerTdsCtxFree(KCIEnv *env, KCIError *err, KCIPicklerTdsCtx *tdsc);

sword KCIPicklerTdsInit(KCIEnv *env, KCIError *err, KCIPicklerTdsCtx *tdsc,
	KCIPicklerTds **tdsh);

sword KCIPicklerTdsFree(KCIEnv *env, KCIError *err, KCIPicklerTds *tdsh);

sword KCIPicklerTdsCreateElementNumber(KCIEnv *env, KCIError *err,
	KCIPicklerTds *tdsh, ub1 prec,
	sb1 scale, KCIPicklerTdsElement *elt);

sword KCIPicklerTdsCreateElementChar(KCIEnv *env, KCIError *err,
	KCIPicklerTds *tdsh, ub2 len,
	KCIPicklerTdsElement *elt);

sword KCIPicklerTdsCreateElementVarchar(KCIEnv *env, KCIError *err,
	KCIPicklerTds *tdsh, ub2 len,
	KCIPicklerTdsElement *elt);

sword KCIPicklerTdsCreateElementRaw(KCIEnv *env, KCIError *err,
	KCIPicklerTds *tdsh, ub2 len,
	KCIPicklerTdsElement *elt);

//sword KCIPicklerTdsCreateElement(KCIEnv *env, KCIError *err,
//	KCIPicklerTds *tdsh, KCITypeCode dty,
//	KCIPicklerTdsElement *elt);

sword KCIPicklerTdsAddAttr(KCIEnv *env, KCIError *err,
	KCIPicklerTds *tdsh, KCIPicklerTdsElement elt);

sword KCIPicklerTdsGenerate(KCIEnv *env, KCIError *err,
	KCIPicklerTds *tdsh);

//sword KCIPicklerTdsGetAttr(KCIEnv *env, KCIError *err,
//	const KCIPicklerTds *tdsh, ub1  attrno,
//	KCITypeCode *typ, ub2  *len);

sword KCIPicklerFdoInit(KCIEnv *env, KCIError *err,
	KCIPicklerFdo **fdoh);

sword KCIPicklerFdoFree(KCIEnv *env, KCIError *err,
	KCIPicklerFdo *fdoh);

sword KCIPicklerImageInit(KCIEnv *env, KCIError *err,
	KCIPicklerFdo *fdoh,
	KCIPicklerTds *tdsh,
	KCIPicklerImage **imgh);

sword KCIPicklerImageFree(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh);

sword KCIPicklerImageAddScalar(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh,
	void  *scalar, ub4  len);

sword KCIPicklerImageAddNullScalar(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh);

sword KCIPicklerImageGenerate(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh);

sword KCIPicklerImageGetScalarSize(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh,
	ub4  attrno, ub4  *size);
#ifdef NO_USED
sword KCIPicklerImageGetScalar(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh, ub4  attrno,
	void  *buf, ub4  *len, KCIInd *ind);

sword KCIPicklerImageCollBegin(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh, const KCIPicklerTds *colltdsh);

sword KCIPicklerImageCollAddScalar(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh, void  *scalar,
	ub4 buflen, KCIInd ind);

sword KCIPicklerImageCollEnd(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh);

/* should take p_svctx for locator stuff */
sword KCIPicklerImageCollBeginScan(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh, const KCIPicklerTds *coll_tdsh,
	ub4 attrnum, ub4 startidx, KCIInd *ind);

sword KCIPicklerImageCollGetScalarSize(KCIEnv *env, KCIError *err,
	const KCIPicklerTds *coll_tdsh, ub4 *size);

sword KCIPicklerImageCollGetScalar(KCIEnv *env, KCIError *err,
	KCIPicklerImage *imgh, void  *buf,
	ub4 *buflen, KCIInd *ind);

sword KCIAnyDataGetType(KCISvcCtx *p_svctx, KCIError *errhp, KCIAnyData *sdata,
	KCITypeCode *tc, KCIType **type);

sword KCIAnyDataIsNull(KCISvcCtx *p_svctx, KCIError *errhp, KCIAnyData *sdata,
	boolean *isnull);

sword KCIAnyDataConvert(KCISvcCtx *p_svctx, KCIError *errhp, KCITypeCode tc,
	KCIType *type, KCIDuration dur, void  *ind, void  *data_val,
	ub4 len, KCIAnyData **sdata);

sword KCIAnyDataBeginCreate(KCISvcCtx *p_svctx, KCIError *errhp, KCITypeCode tc,
	KCIType *type, KCIDuration dur, KCIAnyData **sdata);

sword KCIAnyDataDestroy(KCISvcCtx *p_svctx, KCIError *errhp, KCIAnyData *sdata);

sword KCIAnyDataAttrSet(KCISvcCtx *p_svctx, KCIError *errhp, KCIAnyData *sdata,
	KCITypeCode tc, KCIType *type, void  *ind, void  *attr_val,
	ub4 length, boolean is_any);

sword KCIAnyDataCollAddElem(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyData *sdata, KCITypeCode tc, KCIType *type, void  *ind,
	void  *attr_val, ub4 length, boolean is_any, boolean last_elem);

sword KCIAnyDataEndCreate(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyData *sdata);

sword KCIAnyDataAccess(KCISvcCtx *p_svctx, KCIError *errhp, KCIAnyData *sdata,
	KCITypeCode tc, KCIType *type, void  *ind, void  *attr_val,
	ub4 *length);

sword KCIAnyDataGetCurrAttrNum(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyData *sdata, ub4 *attrnum);

sword KCIAnyDataAttrGet(KCISvcCtx *p_svctx, KCIError *errhp, KCIAnyData *sdata,
	KCITypeCode tc, KCIType *type, void  *ind, void  *attr_val,
	ub4 *length, boolean is_any);

sword KCIAnyDataCollGetElem(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyData *sdata,
	KCITypeCode tc, KCIType *type, void  *ind, void  *celem_val,
	ub4 *length, boolean is_any);

/*------------------------ KCIAnyDataSet interfaces -------------------------*/

/*
NAME
KCIAnyDataSetBeginCreate - KCIAnyDataSet Begin Creation
PARAMETERS
p_svctx (IN/OUT) - The KCI service context.
errhp (IN/OUT) - The KCI error handle. If there is an error, it is
recorded in errhp and this function returns KCI_ERROR.
Diagnostic information can be obtained by calling
KCIErrorGet().
typecode       - typecode corresponding to the KCIAnyDataSet.
type (IN)      - type corresponding to the KCIAnyDataSet. If the typecode
corresponds to a built-in type (KCI_TYPECODE_NUMBER etc.)
, this parameter can be NULL. It should be non NULL for
user defined types (KCI_TYPECODE_OBJECT,
KCI_TYPECODE_REF, collection types etc.)
dur (IN)       - duration for which KCIAnyDataSet is allocated.
data_set (OUT) - Initialized KCIAnyDataSet.
RETURNS        - error code
NOTES
This call allocates an KCIAnyDataSet for the duration of dur and
initializes it with the type information. The KCIAnyDataSet can hold
multiple instances of the given type. For performance reasons, the
KCIAnyDataSet will end up pointing to the passed in KCIType parameter.
It is the responsibility of the caller to ensure that the KCIType is
longer lived (has allocation duration >= the duration of the KCIAnyData
if the KCIType is a transient one, allocation/pin duration >= duration of
the KCIAnyData if the KCIType is a persistent one).

*/
sword KCIAnyDataSetBeginCreate(KCISvcCtx *p_svctx, KCIError *errhp,
	KCITypeCode typecode, const KCIType *type, KCIDuration dur,
	KCIAnyDataSet ** data_set);

/*
NAME
KCIAnyDataSetDestroy  - KCIAnyDataSet Destroy
DESCRIPTION
This call frees the KCIAnyDataSet allocated using
KCIAnyDataSetBeginCreate().
RETURNS
error code.
PARAMETERS
p_svctx (IN/OUT)    - The KCI service context.
errhp (IN/OUT)    - The KCI Error handle.
data_set (IN/OUT) - KCIAnyDataSet to be freed.
*/
sword KCIAnyDataSetDestroy(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyDataSet *data_set);


/*
NAME
KCIAnyDataSetAddInstance - KCIAnyDataSet Add an instance
DESCRIPTION
This call adds a new skeleton instance to the KCIAnyDataSet and all the
attributes of the instance are set to NULL. It returns this skeleton
instance through the KCIAnyData parameter which can be constructed
subsequently by invoking the KCIAnyData API.
RETURNS
error code.
PARAMETERS
p_svctx (IN/OUT)      - The KCI service context.
errhp (IN/OUT)      - The KCI Error handle.
data_set (IN/OUT)   - KCIAnyDataSet to which a new instance is added.
data (IN/OUT)       - KCIAnyData corresponding to the newly added
instance. If (*data) is NULL, a new KCIAnyData will
be allocated for same duration as the KCIAnyDataSet.
If (*data) is not NULL, it will get reused. This
KCIAnyData can be subseqently constructed using the
KCIAnyDataConvert() call or it can be constructed
piece-wise using the KCIAnyDataAttrSet and
KCIAnyDataCollAddElem calls.
NOTES
...
deep copying (of KCIType information nor the data part.) is done in the
returned KCIAnyData. This KCIAnyData cannot be used beyond the allocation
duration of the KCIAnyDataSet (it is like a reference into the
KCIAnyDataSet). The returned KCIAnyData can be reused on subsequent calls
to this function, to sequentially add new data instances to the
KCIAnyDataSet.
*/
sword KCIAnyDataSetAddInstance(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyDataSet *data_set, KCIAnyData **data);

/*
NAME
KCIAnyDataSetEndCreate - KCIAnyDataSet End Creation process.
DESCRIPTION
This call marks the end of KCIAnyDataSet creation. It should be called
...
KCI_ERROR. Diagnostic information can be obtained
by calling KCIErrorGet().
data_set (IN/OUT)     - KCIAnyDataSet that has been fully constructed.
*/
sword KCIAnyDataSetEndCreate(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyDataSet *data_set);

/*
NAME
KCIAnyDataSetGetType - KCIAnyDataSet Get Type of an KCIAnyDataSet
DESCRIPTION
Gets the Type corresponding to an KCIAnyDataSet. It returns the actual
pointer to the type maintained inside an KCIAnyDataSet. No copying is
done for performance reasons. The client is responsible for not using
this type once the KCIAnyDataSet is freed (or its duration ends).
RETURNS
error code.
PARAMETERS
p_svctx (IN/OUT)      - The KCI service context.
errhp (IN/OUT)      - The KCI Error handle.
data_set (IN)       - Initialized KCIAnyDataSet.
tc (OUT)            - The typecode of the type.
type (OUT)          - The type corresponding to the KCIAnyDataSet. This
could be null if the KCIAnyData corresponds to a
built-in type.
*/
sword KCIAnyDataSetGetType(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyDataSet *data_set, KCITypeCode *tc, KCIType **type);

/*
NAME
KCIAnyDataSetGetCount - KCIAnyDataSet Get Count of instances.
DESCRIPTION
This call gets the number of instances in the KCIAnyDataSet.
RETURNS
error code.
PARAMETERS
p_svctx (IN/OUT)      - KCI Service Context
errhp (IN/OUT)      - KCI Error handle
data_set (IN)       - Well formed KCIAnyDataSet.
count (OUT)         - number of instances in KCIAnyDataSet
*/
sword KCIAnyDataSetGetCount(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyDataSet *data_set, ub4 *count);

/*
NAME
KCIAnyDataSetGetInstance - KCIAnyDataSet Get next instance.
DESCRIPTION
Only sequential access to the instances in an KCIAnyDataSet is allowed.
This call returns the KCIAnyData corresponding to an instance at the
current position and updates the current position. Subsequently, the
KCIAnyData access routines may be used to access the instance.
RETURNS
error code. Returns KCI_NO_DATA if the current position is at the end of
the set, KCI_SUCCESS otherwise.
PARAMETERS
p_svctx (IN/OUT)      - KCI Service Context
errhp (IN/OUT)      - KCI Error handle
data_set (IN)       - Well formed KCIAnyDataSet
data (IN/OUT)       - KCIAnyData corresponding to the instance. If (*data)
is NULL, a new KCIAnyData will be allocated for same
duration as the KCIAnyDataSet. If (*data) is not NULL
, it will get reused. This KCIAnyData can be
subsequently accessed using the KCIAnyDataAccess()
call or piece-wise by using the KCIAnyDataAttrGet()
call.
NOTE
No Destruction of the old value is done here. It is the responsibility of
the caller to destroy the old value pointed to by (*data) and set (*data)
to a null pointer before beginning to make a sequence of this call. No deep
copying (of KCIType information nor the data part.) is done in the returned
KCIAnyData. This KCIAnyData cannot be used beyond the allocation duration
of the KCIAnyDataSet (it is like a reference into the KCIAnyDataSet). The
returned KCIAnyData can be reused on subsequent calls to this function to
sequentially access the KCIAnyDataSet.
*/
sword KCIAnyDataSetGetInstance(KCISvcCtx *p_svctx, KCIError *errhp,
	KCIAnyDataSet *data_set, KCIAnyData **data);

/*--------------------- End of KCIAnyDataSet interfaces ---------------------*/
#endif
...
*/
KCISvcCtx *xaosvch(KunText *dbname);
...
XA library
*/
KCISvcCtx *xaoSvcCtx(KunText *dbname);
...
*/
int xaosterr(KCISvcCtx *svch, sb4 error);
/*-------------------------- End Extensions ---------------------------------*/
/*---------------------- Extensions to NLS cartridge service ----------------*/
/* ----------------------- KCINlsGetInfo ------------------------------------*/
/*
NAME
KCINlsGetInfo - Get NLS info from KCI environment handle
REMARKS
This function generates language information specified by item from KCI
environment handle envhp into an array pointed to by buf within size
limitation as buflen.
RETURNS
KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR on wrong item.
envhp(IN/OUT)
KCI environment handle.
errhp(IN/OUT)
The KCI error handle. If there is an error, it is record in errhp and
...
is 32 bytes.
item(IN)
It specifies to get which item in KCI environment handle and can be one
of following values:
KCI_NLS_DAYNAME1 : Native name for Monday.
KCI_NLS_DAYNAME2 : Native name for Tuesday.
KCI_NLS_DAYNAME3 : Native name for Wednesday.
KCI_NLS_DAYNAME4 : Native name for Thursday.
KCI_NLS_DAYNAME5 : Native name for Friday.
KCI_NLS_DAYNAME6 : Native name for for Saturday.
KCI_NLS_DAYNAME7 : Native name for for Sunday.
KCI_NLS_ABDAYNAME1 : Native abbreviated name for Monday.
KCI_NLS_ABDAYNAME2 : Native abbreviated name for Tuesday.
KCI_NLS_ABDAYNAME3 : Native abbreviated name for Wednesday.
KCI_NLS_ABDAYNAME4 : Native abbreviated name for Thursday.
KCI_NLS_ABDAYNAME5 : Native abbreviated name for Friday.
KCI_NLS_ABDAYNAME6 : Native abbreviated name for for Saturday.
KCI_NLS_ABDAYNAME7 : Native abbreviated name for for Sunday.
KCI_NLS_MONTHNAME1 : Native name for January.
KCI_NLS_MONTHNAME2 : Native name for February.
KCI_NLS_MONTHNAME3 : Native name for March.
KCI_NLS_MONTHNAME4 : Native name for April.
KCI_NLS_MONTHNAME5 : Native name for May.
KCI_NLS_MONTHNAME6 : Native name for June.
KCI_NLS_MONTHNAME7 : Native name for July.
KCI_NLS_MONTHNAME8 : Native name for August.
KCI_NLS_MONTHNAME9 : Native name for September.
KCI_NLS_MONTHNAME10 : Native name for October.
KCI_NLS_MONTHNAME11 : Native name for November.
KCI_NLS_MONTHNAME12 : Native name for December.
KCI_NLS_ABMONTHNAME1 : Native abbreviated name for January.
KCI_NLS_ABMONTHNAME2 : Native abbreviated name for February.
KCI_NLS_ABMONTHNAME3 : Native abbreviated name for March.
KCI_NLS_ABMONTHNAME4 : Native abbreviated name for April.
KCI_NLS_ABMONTHNAME5 : Native abbreviated name for May.
KCI_NLS_ABMONTHNAME6 : Native abbreviated name for June.
KCI_NLS_ABMONTHNAME7 : Native abbreviated name for July.
KCI_NLS_ABMONTHNAME8 : Native abbreviated name for August.
KCI_NLS_ABMONTHNAME9 : Native abbreviated name for September.
KCI_NLS_ABMONTHNAME10 : Native abbreviated name for October.
KCI_NLS_ABMONTHNAME11 : Native abbreviated name for November.
KCI_NLS_ABMONTHNAME12 : Native abbreviated name for December.
KCI_NLS_YES : Native string for affirmative response.
KCI_NLS_NO : Native negative response.
KCI_NLS_AM : Native equivalent string of AM.
KCI_NLS_PM : Native equivalent string of PM.
KCI_NLS_AD : Native equivalent string of AD.
KCI_NLS_BC : Native equivalent string of BC.
KCI_NLS_DECIMAL : decimal character.
KCI_NLS_GROUP : group separator.
KCI_NLS_DEBIT : Native symbol of debit.
KCI_NLS_CREDIT : Native sumbol of credit.
KCI_NLS_DATEFORMAT : Oracle date format.
KCI_NLS_INT_CURRENCY: International currency symbol.
KCI_NLS_LOC_CURRENCY : Locale currency symbol.
KCI_NLS_LANGUAGE : Language name.
KCI_NLS_ABLANGUAGE : Abbreviation for language name.
KCI_NLS_TERRITORY : Territory name.
KCI_NLS_CHARACTER_SET : Character set name.
KCI_NLS_LINGUISTIC : Linguistic name.
KCI_NLS_CALENDAR : Calendar name.
KCI_NLS_DUAL_CURRENCY : Dual currency symbol.
*/
sword KCINlsGetInfo(void  *envhp, KCIError *errhp, KunText *buf,
	size_t buflen, ub2 item);

/* ----------------------- KCINlsNumericInfoGet -----------------------------*/
/*
NAME
KCINlsNumericInfoGet - Get NLS numeric info from KCI environment handle
REMARKS
This function generates numeric language information specified by item
from KCI environment handle envhp into an output number variable.
RETURNS
KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR on wrong item.
envhp(IN/OUT)
KCI environment handle. If handle invalid, returns KCI_INVALID_HANDLE.
errhp(IN/OUT)
The KCI error handle. If there is an error, it is record in errhp and
this function returns a NULL pointer. Diagnostic information can be
obtained by calling KCIErrorGet().
val(OUT)
Pointer to the output number variable. On KCI_SUCCESS return, it will
contain the requested NLS numeric info.
item(IN)
It specifies to get which item in KCI environment handle and can be one
of following values:
KCI_NLS_CHARSET_MAXBYTESZ : Maximum character byte size for KCI
environment or session handle charset
KCI_NLS_CHARSET_FIXEDWIDTH: Character byte size for fixed-width charset;
0 for variable-width charset
*/
sword KCINlsNumericInfoGet(void  *envhp, KCIError *errhp, sb4 *val, ub2 item);

/* ----------------------- KCINlsCharSetNameToId ----------------------------*/
/*
NAME
KCINlsCharSetNameToId - Get Oracle charset id given Oracle charset name
REMARKS
...
character set name and KCI handle are valid; otherwise returns 0.
envhp(IN/OUT)
KCI environment handle.
name(IN)
...
will be returned.
*/
ub2 KCINlsCharSetNameToId(void  *envhp, const KunText *name);

/* ----------------------- KCINlsCharSetIdToName ----------------------------*/
/*
NAME
KCINlsCharSetIdToName - Get Oracle charset name given Oracle charset id
REMARKS
This function will get the Oracle character set name corresponding to
the given Oracle character set id.
RETURNS
KCI_SUCCESS, KCI_INVALID_HANDLE, or KCI_ERROR
envhp(IN/OUT)
KCI environment handle. If handle invalid, returns KCI_INVALID_HANDLE.
buf(OUT)
Pointer to the destination buffer. On KCI_SUCCESS return, it will contain
the null-terminated string for character set name.
buflen(IN)
Size of destination buffer. Recommended size is KCI_NLS_MAXBUFSZ for
guarantee to store an Oracle character set name. If it's smaller than
the length of the character set name, the function will return KCI_ERROR.
id(IN)
Oracle character set id.
*/
sword KCINlsCharSetIdToName(void  *envhp, KunText *buf, size_t buflen, ub2 id);

/* ----------------------- KCINlsNameMap ------------------------------------*/
/*
NAME
KCINlsNameMap - Map NLS naming from Oracle to other standards and vice
versa
REMARKS
...
KCI environment handle. If handle invalid, returns KCI_INVALID_HANDLE.
buf(OUT)
Pointer to the destination buffer. On KCI_SUCCESS return, it will
contain null-terminated string for requested mapped name.
buflen(IN)
The size of destination buffer. Recommended size is KCI_NLS_MAXBUFSZ
for guarantee to store an NLS name. If it is smaller than the length
of the name, the function will return KCI_ERROR.
srcbuf(IN)
Pointer to null-terminated NLS name. If it is not a valid name in its
define scope, the function will return KCI_ERROR.
flag(IN)
It specifies name mapping direction and can take the following values:
KCI_NLS_CS_IANA_TO_ORA : Map character set name from IANA to Oracle
KCI_NLS_CS_ORA_TO_IANA : Map character set name from Oracle to IANA
KCI_NLS_LANG_ISO_TO_ORA : Map language name from ISO to Oracle
KCI_NLS_LANG_ORA_TO_ISO : Map language name from Oracle to ISO
KCI_NLS_TERR_ISO_TO_ORA : Map territory name from ISO to Oracle
KCI_NLS_TERR_ORA_TO_ISO : Map territory name from Oracle to ISO
KCI_NLS_TERR_ISO3_TO_ORA : Map territory name from 3-letter ISO
abbreviation to Oracle
KCI_NLS_TERR_ORA_TO_ISO3 : Map territory name from Oracle to 3-letter
ISO abbreviation
*/
sword KCINlsNameMap(void  *envhp, KunText *buf, size_t buflen,
	const KunText *srcbuf, ub4 flag);

/* -------------------- KCIMultiByteToWideChar ------------------------------*/
/*
NAME
KCIMultiByteToWideChar - Convert a null terminated multibyte string into
wchar
REMARKS
...
KCI_SUCCESS, KCI_INVALID_HANDLE or KCI_ERROR
envhp(IN/OUT)
KCI environment handle to determine the character set of string.
dst (OUT)
...
*/
sword KCIMultiByteToWideChar(void  *envhp, KCIWchar *dst, const KunText *src,
	size_t *rsize);
...
/*
NAME
KCIMultiByteInSizeToWideChar - Convert a mulitbyte string in length into
wchar
REMARKS
...
*/
sword KCIMultiByteInSizeToWideChar(void  *envhp, KCIWchar *dst,
	size_t dstsz, const KunText *src,
...
/*
NAME
KCIWideCharToMultiByte - Convert a null terminated wchar string into
multibyte
REMARKS
...
If it is NULL pointer, nothing to return.
*/
sword KCIWideCharToMultiByte(void  *envhp, KunText *dst, const KCIWchar *src,
	size_t *rsize);
...
/*
NAME
KCIWideCharInSizeToMultiByte - Convert a wchar string in length into
mulitbyte
REMARKS
...
If it is NULL pointer, nothing to return.
*/
sword KCIWideCharInSizeToMultiByte(void  *envhp, KunText *dst,
	size_t dstsz, const KCIWchar *src,
	size_t srcsz, size_t *rsize);
...
/*
NAME
KCIWideCharIsAlnum - test whether wc is a letter or decimal digit
REMARKS
It tests whether wc is a letter or decimal digit.
RETURNS
TRUE or FLASE.
envhp(IN/OUT)
KCI environment handle to determine the character set .
wc(IN)
Wchar for testing.
*/
boolean KCIWideCharIsAlnum(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsAlpha -------------------------------*/
/*
NAME
KCIWideCharIsAlpha - test whether wc is an alphabetic letter
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsAlpha(void  *envhp, KCIWchar wc);


/* --------------------- KCIWideCharIsCntrl ---------------------------------*/
/*
NAME
KCIWideCharIsCntrl - test whether wc is a control character
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsCntrl(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsDigit -------------------------------*/
/*
NAME
KCIWideCharIsDigit - test whether wc is a decimal digit character
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsDigit(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsGraph -------------------------------*/
/*
NAME
KCIWideCharIsGraph - test whether wc is a graph character
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsGraph(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsLower -------------------------------*/
/*
NAME
KCIWideCharIsLower - test whether wc is a lowercase letter
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsLower(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsPrint -------------------------------*/
/*
NAME
KCIWideCharIsPrint - test whether wc is a printable character
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsPrint(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsPunct -------------------------------*/
/*
NAME
KCIWideCharIsPunct - test whether wc is a punctuation character
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsPunct(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsSpace -------------------------------*/
/*
NAME
KCIWideCharIsSpace - test whether wc is a space character
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsSpace(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharIsUpper -------------------------------*/
/*
NAME
KCIWideCharIsUpper - test whether wc is a uppercase letter
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsUpper(void  *envhp, KCIWchar wc);


/*----------------------- KCIWideCharIsXdigit -------------------------------*/
/*
NAME
KCIWideCharIsXdigit - test whether wc is a hexadecimal digit
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsXdigit(void  *envhp, KCIWchar wc);


/* --------------------- KCIWideCharIsSingleByte ----------------------------*/
/*
NAME
KCIWideCharIsSingleByte - test whether wc is a single-byte character
REMARKS
...
Wchar for testing.
*/
boolean KCIWideCharIsSingleByte(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharToLower -------------------------------*/
/*
NAME
KCIWideCharToLower - Convert a wchar into the lowercase
REMARKS
...
*/
KCIWchar KCIWideCharToLower(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharToUpper -------------------------------*/
/*
NAME
KCIWideCharToUpper - Convert a wchar into the uppercase
REMARKS
...
*/
KCIWchar KCIWideCharToUpper(void  *envhp, KCIWchar wc);


/* ----------------------- KCIWideCharStrcmp --------------------------------*/
/*
NAME
KCIWideCharStrcmp - compare two null terminated wchar string
REMARKS
...
following values:
KCI_NLS_BINARY : for the binary comparison, this is default value.
KCI_NLS_LINGUISTIC : for linguistic comparison specified in the locale.
This flag can be ORed with KCI_NLS_CASE_INSENSITIVE for case-insensitive
comparison.
*/
int KCIWideCharStrcmp(void  *envhp, const KCIWchar *wstr1,
	const KCIWchar *wstr2, int flag);


/* ----------------------- KCIWideCharStrncmp -------------------------------*/
/*
NAME
KCIWideCharStrncmp - compare twe wchar string in length
REMARKS
This function is similar to KCIWideCharStrcmp(), except that at most len1
...
comparison.
*/
int KCIWideCharStrncmp(void  *envhp, const KCIWchar *wstr1, size_t len1,
	const KCIWchar *wstr2, size_t len2, int flag);


/* ----------------------- KCIWideCharStrcat --------------------------------*/
/*
NAME
KCIWideCharStrcat - concatenate two wchar strings
REMARKS
...
*/
size_t KCIWideCharStrcat(void  *envhp, KCIWchar *wdststr,
	const KCIWchar *wsrcstr);


/* ----------------------- KCIWideCharStrchr --------------------------------*/
/*
NAME
KCIWideCharStrchr - Search the first occurrence of wchar in a wchar string
REMARKS
...
Wchar to search for.
*/
KCIWchar *KCIWideCharStrchr(void  *envhp, const KCIWchar *wstr,
	KCIWchar wc);
...
/*
NAME
KCIWideCharStrcpy - copy a wchar string
REMARKS
...
*/
size_t KCIWideCharStrcpy(void  *envhp, KCIWchar *wdststr,
	const KCIWchar *wsrcstr);
...
/*
NAME
KCIWideCharStrlen - Return number of character in a wchar string
REMARKS
...
Pointer to the source wchar string.
*/
size_t KCIWideCharStrlen(void  *envhp, const KCIWchar *wstr);


/* ----------------------- KCIWideCharStrncat -------------------------------*/
/*
NAME
KCIWideCharStrncat - Concatenate wchar string in length
REMARKS
This function is similar to KCIWideCharStrcat(), except that at most n
...
*/
size_t KCIWideCharStrncat(void  *envhp, KCIWchar *wdststr,
	const KCIWchar *wsrcstr, size_t n);


/* ----------------------- KCIWideCharStrncpy -------------------------------*/
/*
NAME
KCIWideCharStrncpy - Copy wchar string in length
REMARKS
This function is similar to KCIWideCharStrcpy(), except that at most n
...
*/
size_t KCIWideCharStrncpy(void  *envhp, KCIWchar *wdststr,
	const KCIWchar *wsrcstr, size_t n);
...
/*
NAME
KCIWideCharStrrchr - search the last occurrence of a wchar in wchar string
REMARKS
...
Wchar to search for.
*/
KCIWchar *KCIWideCharStrrchr(void  *envhp, const KCIWchar *wstr,
	KCIWchar wc);
...
/*
NAME
KCIWideCharStrCaseConversion - convert a wchar string into lowercase or
uppercase
REMARKS
...
KCI_NLS_UPPERCASE : convert to uppercase.
KCI_NLS_LOWERCASE: convert to lowercase.
This flag can be ORed with KCI_NLS_LINGUISTIC to specify that the
linguistic setting in the locale will be used for case conversion.
*/
size_t KCIWideCharStrCaseConversion(void  *envhp, KCIWchar *wdststr,
	const KCIWchar *wsrcstr, ub4 flag);


/*---------------------- KCIWideCharDisplayLength ---------------------------*/
/*
NAME
KCIWideCharDisplayLength - Calculate the display length for a wchar
REMARKS
...
Wchar character.
*/
size_t KCIWideCharDisplayLength(void  *envhp, KCIWchar wc);


/*---------------------- KCIWideCharMultiByteLength -------------------------*/
/*
NAME
KCIWideCharMultiByteLength - Determine byte size in multi-byte encoding
REMARKS
...
Wchar character.
*/
size_t KCIWideCharMultiByteLength(void  *envhp, KCIWchar wc);


/* ----------------------- KCIMultiByteStrcmp -------------------------------*/
/*
NAME
KCIMultiByteStrcmp - Compare two multi-byte strings
REMARKS
...
comparison.
*/
int KCIMultiByteStrcmp(void  *envhp, const KunText *str1,
	const KunText *str2, int flag);


/*----------------------- KCIMultiByteStrncmp -------------------------------*/
/*
NAME
KCIMultiByteStrncmp - compare two strings in length
REMARKS
This function is similar to KCIMultiBytestrcmp(), except that at most
...
comparison.
*/
int KCIMultiByteStrncmp(void  *envhp, const KunText *str1, size_t len1,
	KunText *str2, size_t len2, int flag);


/*----------------------- KCIMultiByteStrcat --------------------------------*/
/*
NAME
KCIMultiByteStrcat - concatenate multibyte strings
REMARKS
...
null-terminator.
envhp(IN/OUT)
Pointer to KCI environment handle
dststr(IN/OUT)
Pointer to the destination multi-byte string for appending.
srcstr(IN)
Pointer to the source string to append.
*/
size_t KCIMultiByteStrcat(void  *envhp, KunText *dststr,
	const KunText *srcstr);


/*------------------------- KCIMultiByteStrcpy ------------------------------*/
/*
NAME
KCIMultiByteStrcpy - copy multibyte string
REMARKS
...
envhp(IN/OUT)
Pointer to the KCI environment handle.
srcstr(OUT)
Pointer to the destination buffer.
dststr(IN)
Pointer to the source multi-byte string.
*/
size_t KCIMultiByteStrcpy(void  *envhp, KunText *dststr,
	const KunText *srcstr);
...
/*
NAME
KCIMultiByteStrlen - Calculate multibyte string length
REMARKS
...
Pointer to the source multi-byte string.
*/
size_t KCIMultiByteStrlen(void  *envhp, const KunText *str);


/*----------------------- KCIMultiByteStrncat -------------------------------*/
/*
NAME
KCIMultiByteStrncat - concatenate string in length
REMARKS
This function is similar to KCIMultiBytestrcat(), except that at most n
...
*/
size_t KCIMultiByteStrncat(void  *envhp, KunText *dststr,
	const KunText *srcstr, size_t n);


/*----------------------- KCIMultiByteStrncpy -------------------------------*/
/*
NAME
KCIMultiByteStrncpy - copy multibyte string in length
REMARKS
This function is similar to KCIMultiBytestrcpy(), except that at most n
...
number of bytes copied not including the ending null-terminator.
envhp(IN/OUT)
Pointer to a KCI environment handle.
dststr(IN)
Pointer to the source multi-byte string.
srcstr(OUT)
Pointer to the destination buffer.
...
*/
size_t KCIMultiByteStrncpy(void  *envhp, KunText *dststr,
	const KunText *srcstr, size_t n);
...
/*
NAME
KCIMultiByteStrnDisplayLength - calculate the display length for a
multibyt string
REMARKS
...
*/
size_t KCIMultiByteStrnDisplayLength(void  *envhp, const KunText *str1,
	size_t n);
...
linguistic setting in the locale will be used for case conversion.
*/
size_t KCIMultiByteStrCaseConversion(void  *envhp, KunText *dststr,
	const KunText *srcstr, ub4 flag);


/*------------------------- KCICharSetToUnicode -----------------------------*/
/*
NAME
KCICharSetToUnicode - convert multibyte string into Unicode as UCS2
REMARKS
...
KCI_SUCCESS, KCI_INVALID_HANDLE or KCI_ERROR
envhp(IN/OUT)
Pointer to an KCI environment handle
dst(OUT)
...
sword KCICharSetToUnicode(void  *envhp, ub2 *dst, size_t dstlen,
	const KunText *src, size_t  srclen, size_t *rsize);


/*------------------------- KCIUnicodeToCharSet -----------------------------*/
/*
NAME
KCIUnicodeToCharSet - convert Unicode into multibyte
REMARKS
...
set specified in KCI environment handle, a replacement character will be
used for it. In this case, KCICharSetConversionIsReplacementUsed() will
return ture.
RETURNS
KCI_SUCCESS, KCI_INVALID_HANDLE or KCI_ERROR
envhp(IN/OUT)
...
If it is a NULL pointer, nothing to return.
*/
sword KCIUnicodeToCharSet(void  *envhp, KunText *dst, size_t dstlen,
	const ub2 *src, size_t srclen, size_t *rsize);

/*----------------------- KCINlsCharSetConvert ------------------------------*/
/*
NAME
KCINlsCharSetConvert - convert between any two character set.
REMARKS
...
or destination character set id is KCI_UTF16ID, given and return data
...
data.
To get character set id from name, KCINlsCharSetNameToId can be used.
To check if derived data in the destination buffer contains any
replacement character resulting from conversion failure,
KCICharSetConversionIsReplacementUsed can be used to get the status.
Data alignment should be guaranteed by a caller. For example, UTF-16 data
should be aligned to ub2 type.

RETURNS
KCI_SUCCESS or KCI_ERROR.
errhp(IN/OUT)
KCI error handle. If there is an error, it is recorded in errhp and this
...
return.
*/
sword KCINlsCharSetConvert(void  *envhp, KCIError *errhp,
	ub2 dstid, void  *dstp, size_t dstlen,
	ub2 srcid, const void  *srcp, size_t srclen,
	size_t *rsize);


/* ------------------- KCICharsetConversionIsReplacementUsed ----------------*/
/*
NAME
KCICharsetConversionIsReplacementUsed - chech if replacement is used in
conversion
REMARKS
...
of KCICharsetUcs2ToMb().
RETURNS
TRUE is the replacement character was used in last KCICharsetUcs2ToMb()
invoking, else FALSE.
envhp(IN/OUT)
KCI environment handle. This should be the first handle passed to
KCICharsetUcs2ToMb().
*/
boolean KCICharSetConversionIsReplacementUsed(void  *envhp);

/*------------------- KCINlsEnvironmentVariableGet -----------------*/
/*
NAME
KCINlsEnvironmentVariableGet - get a value of NLS environment variable.
...
KCI_NLS_CHARSET_ID  - NLS_LANG character set id in ub2 data type.
KCI_NLS_NCHARSET_ID - NLS_NCHAR character set id in ub2 data type.
charset(IN) -
Character set id for retrieved string data. If it is 0, NLS_LANG will be
used. KCI_UTF16ID is a valid id. In case of numeric data, this argument
is ignored.
rsize(OUT) -
...
*/
sword KCINlsEnvironmentVariableGet(void   *valp, size_t size, ub2 item,
...
/*
NAME
KCIMessageOpen - open a locale message file
REMARKS
...
KCI_SUCCESS, KCI_INVALID_HANDLE or KCI_ERROR
envhp(IN/OUT)
A pointer to KCI environment handle for message language.
errhp(IN/OUT)
The KCI error handle. If there is an error, it is record in errhp and this
...
KCI_DURATION_CALL
KCI_DURATION_STATEMENT
KCI_DURATION_SESSION
KCI_DURATION_TRANSACTION
For the detail description, please refer to Memory Related Service
Interfaces section.
*/
sword KCIMessageOpen(void  *envhp, KCIError *errhp, KCIMsg **msghp,
	const KunText *product, const KunText *facility,
	KCIDuration dur);
...
/*
NAME
KCIMessageGet - get a locale message from a message handle
REMARKS
...
*/
KunText *KCIMessageGet(KCIMsg *msgh, ub4 msgno, KunText *msgbuf,
	size_t buflen);

/*------------------------- KCIMessageClose ---------------------------------*/
/*
NAME
KCIMessageClose - close a message handle
REMARKS
This function closes a message handle pointed to by msgh and frees any
memory assKCIated with this handle.
RETURNS
KCI_SUCCESS, KCI_INVALID_HANDLE or KCI_ERROR
envhp(IN/OUT)
A pointer to KCI environment handle for message language.
...
KCIMessageOpen().
*/
sword KCIMessageClose(void  *envhp, KCIError *errhp, KCIMsg *msghp);

/*--------------- End of Extensions to NLS cartridge service ----------------*/


/*----------------- Extensions to KCI Thread interface ---------------------*/
/*****************************************************************************
DESCRIPTION
******************************************************************************
1 Threads Interface

The KCIThread package provides a number of commonly used threading
...
KCIThread does not provide a portable implementation of multithreaded
...
implementation of KCIThread.  As a result, products that rely on all of
KCIThread's functionality will not port to all platforms.  Products that must
port to all platforms must use only a subset of KCIThread's functionality.
This issue is discussed further in later sections of this document.

The KCIThread API is split into four main parts.  Each part is described
briefly here.  The following subsections describe each in greater detail.

1. Initialization and Termination Calls

These calls deal with the initialization and termination of KCIThread.
Initialization of KCIThread initializes the KCIThread context which is
a member of the KCI environment or session handle.  This context is
required for other KCIThread calls.
...
As a result, KCIThread clients that use only these primitives will not
...
multi-threaded environment, call KCIThreadIsMulti() before calling an
KCIThread active primitive.


1.1 Initialization & Termination
==================================

The types and functions described in this section are assKCIated with the
initialization and termination of the KCIThread package.  KCIThread must
be properly initialized before any of its functionality can be used.
KCIThread's process initialization function, 'KCIThreadProcessInit()',
must be called with care; see below.

The observed behavior of the initialization and termination functions is the
same regardless of whether KCIThread is in single-threaded or multi-threaded
environment.  It is OK to call the initialization functions from both generic
and operating system specific (OSD) code.

1.1.1 Types

KCIThreadContext - KCIThread Context
-------------------------------------

Most calls to KCIThread functions take the KCI environment or session
handle as a parameter.  The KCIThread context is part of the KCI
environment or session handle and it must be initialized by calling
'KCIThreadInit()'.  Termination of the KCIThread context occurs by calling
'KCIThreadTerm()'.

The KCIThread context is a private data structure.  Clients must NEVER
attempt to examine the contents of the context.

1.1.2  KCIThreadProcessInit

KCIThreadProcessInit - KCIThread Process INITialization
--------------------------------------------------------

Description

This function should be called to perform KCIThread process
initialization.
...
Whether or not this function needs to be called depends on how KCI
...
to any other KCIThread functions.  Subsequent calls can be made
without restriction; they will not have any effect.

* In a multi-threaded application, this function MUST be called.  The
first call to it MUST occur 'strictly before' any other KCIThread
calls; i.e., no other calls to KCIThread functions (including other
...
KCIThreadInit - KCIThread INITialize
-------------------------------------

Description

This initializes KCIThread context.
...
err(IN/OUT): The KCI error handle.  If there is an error and KCI_ERROR
is returned, the error is recorded in err and diagnostic
information can be obtained by calling KCIErrorGet().

Returns

KCI_SUCCESS, KCI_ERROR or KCI_INVALID_HANDLE.

Notes

It is illegal for KCIThread clients to try an examine the memory
pointed to by the returned pointer.

It is safe to make concurrent calls to 'KCIThreadInit()'.  Unlike
'KCIThreadProcessInit()',  there is no need to have a first call
that occurs before all the others.

The first time 'KCIThreadInit()' is called, it initilaizes the KCI
Thread context.  It also saves a pointer to the context in some system
dependent manner.  Subsequent calls to 'KCIThreadInit()' will return
the same context.

Each call to 'KCIThreadInit()' must eventually be matched by a call to
'KCIThreadTerm()'.

KCIThreadTerm - KCIThread TERMinate
------------------------------------

Description

This should be called to release the KCIThread context.  It should be
called exactly once for each call made to 'KCIThreadInit()'.
...
It is safe to make concurrent calls to 'KCIThreadTerm()'.

'KCIThreadTerm()' will not do anything until it has been called as
many times as 'KCIThreadInit()' has been called.  When that happens,
it terminates the KCIThread layer and frees the memory allocated for
the context.  Once this happens, the context should not be re-used.
It will be necessary to obtain a new one by calling 'KCIThreadInit()'.


KCIThreadIsMulti - KCIThread Is Multi-Threaded?
------------------------------------------------
...
1.2.1.1  KCIThreadMutex - KCIThread Mutual Exclusion Lock
-----------------------------------------------------------

The type 'KCIThreadMutex' is used to represent a mutual exclusion lock
...
using 'KCIThreadMutexInit()'.  Once they are no longer needed, they must be
destroyed using 'KCIThreadMutexDestroy()'.  A mutex pointer must NOT be
used after it is destroyed.

A thread can acquire a mutex by using either 'KCIThreadMutexAcquire()' or
'KCIThreadMutexTry()'.  They both ensure that only one thread at a time is
allowed to hold a given mutex.  A thread that holds a mutex can release it
by calling 'KCIThreadMutexRelease()'.


1.2.1.2  KCIThreadKey - KCIThread Key for Thread-Specific Data
----------------------------------------------------------------
...
Keys can be created using 'KCIThreadKeyInit()'.  When a key is created, its
value is initialized to 'NULL' for all threads.

A thread can set a key's value using 'KCIThreadKeySet()'.  A thread can
get a key's value using 'KCIThreadKeyGet()'.

The KCIThread key functions will save and retrieve data SPECIFIC TO THE
THREAD.  When clients maintain a pool of threads and assign the threads to
different tasks, it *may not* be appropriate for a task to use KCIThread
key functions to save data assKCIated with it.  Here is a scenario of how
...
in the thread using KCIThread key functions.  After the initialization,
...
pools should be aware of this and be cautious when using KCIThread key
functions.


1.2.1.3  KCIThreadKeyDestFunc - KCIThread Key Destructor Function Type
------------------------------------------------------------------------

This is the type of a pointer to a key's destructor routine.  Keys can be
assKCIated with a destructor routine when they are created (see
'KCIThreadKeyInit()').
...
1.2.1.4  KCIThreadId - KCIThread Thread ID
--------------------------------------------

Type 'KCIThreadId' is the type that will be used to identify a thread.
At any given time, no two threads will ever have the same 'KCIThreadId'.
However, 'KCIThreadId' values can be recycled; i.e., once a thread dies,
a new thread may be created that has the same 'KCIThreadId' as the one
...
within thread T.  This will be done via KCIThreadIdGet().

The 'KCIThreadId' type supports the concept of a NULL thread ID: the NULL
...
KCIThreadMutexInit - KCIThread MuteX Initialize
-----------------------------------------------
...
sword KCIThreadMutexInit(void *hndl, KCIError *err,
KCIThreadMutex **mutex);
...
KCIThreadMutexDestroy - KCIThread MuteX Destroy
-----------------------------------------------
...
sword KCIThreadMutexDestroy(void *hndl, KCIError *err,
KCIThreadMutex **mutex);
...
KCIThreadMutexAcquire - KCIThread MuteX Acquire
-----------------------------------------------
...
sword KCIThreadMutexAcquire(void *hndl, KCIError *err,
KCIThreadMutex *mutex);

hndl(IN/OUT): The KCI environment or session handle.

err(IN/OUT): The KCI error handle.  If there is an error, it is
recorded in err and this function returns KCI_ERROR.
Diagnostic information can be obtained by calling
KCIErrorGet().
...
KCIThreadMutexRelease - KCIThread MuteX Release
-----------------------------------------------
...
sword KCIThreadMutexRelease(void *hndl, KCIError *err,
KCIThreadMutex *mutex);
...
KCIThreadKeyInit - KCIThread KeY Initialize
-------------------------------------------
...
sword KCIThreadKeyInit(void *hndl, KCIError *err, KCIThreadKey **key,
KCIThreadKeyDestFunc destFn);
...
key(OUT):    The 'KCIThreadKey' in which to create the new key.
...
initialized key is return.  That key can be used with 'KCIThreadKeyGet()'
and 'KCIThreadKeySet()'.  The initial value of the key will be 'NULL' for
all threads.
...
KCIThreadKeyDestroy - KCIThread KeY DESTROY
-------------------------------------------
...
sword KCIThreadKeyDestroy(void *hndl, KCIError *err,
KCIThreadKey **key);
...
key(IN/OUT):  The 'KCIThreadKey' in which to destroy the key.
...
key create routine.  This new destroy function 'KCIThreadKeyDestroy' is
used to terminate any resources KCI THREAD acquired when it created
'key'.  [The 'KCIThreadKeyDestFunc' callback type is a key VALUE
...
KCIThreadKeyGet - KCIThread KeY Get value
-----------------------------------------
...
sword KCIThreadKeyGet(void *hndl, KCIError *err, KCIThreadKey *key,
void **pValue);
...
sword KCIThreadKeySet(void *hndl, KCIError *err, KCIThreadKey *key,
void *value);
...
KCIThreadIdInit - KCIThread Thread Id INITialize
--------------------------------------------------
...
KCIThreadIdDestroy - KCIThread Thread Id DESTROY
--------------------------------------------------
...
'tid' should be initialized by KCIThreadIdInit().


KCIThreadIdSet - KCIThread Thread Id Set
-----------------------------------------

Description

This sets one 'KCIThreadId' to another.

Prototype

sword KCIThreadIdSet(void *hndl, KCIError *err,
KCIThreadId *tidDest,
KCIThreadId *tidSrc);
...
tidDest(OUT):   This should point to the location of the 'KCIThreadId'
to be set to.

tidSrc(IN):     This should point to the 'KCIThreadId' to set from.
...
KCIThreadIdSetNull - KCIThread Thread Id Set Null
---------------------------------------------------------

Description

This sets the NULL thread ID to a given 'KCIThreadId'.

Prototype

sword KCIThreadIdSetNull(void *hndl, KCIError *err,
KCIThreadId *tid);
...
tid(OUT):    This should point to the 'KCIThreadId' in which to put
the NULL thread ID.
...
KCIThreadIdGet - KCIThread Thread Id Get
------------------------------------------

Description

This retrieves the 'KCIThreadId' of the thread in which it is called.

Prototype

sword KCIThreadIdGet(void *hndl, KCIError *err,
KCIThreadId *tid);
...
When KCIThread is used in a single-threaded environment,
KCIThreadIdGet() will always place the same value in the location
...
KCIThreadIdSame - KCIThread Thread Ids Same?
----------------------------------------------

Description

This determines whether or not two 'KCIThreadId's represent the same
thread.

Prototype

sword KCIThreadIdSame(void *hndl, KCIError *err,
KCIThreadId *tid1, KCIThreadId *tid2,
boolean *result);
...
tid1(IN):   Pointer to the first 'KCIThreadId'.

tid2(IN):   Pointer to the second 'KCIThreadId'.
...
'ti1d' and 'tid2' should be initialized by KCIThreadIdInit().


KCIThreadIdNull - KCIThread Thread Id NULL?
---------------------------------------------

Description

This determines whether or not a given 'KCIThreadId' is the NULL thread
ID.

Prototype

sword KCIThreadIdNull(void *hndl, KCIError *err,
KCIThreadId *tid,
boolean *result);
...
tid(IN):    Pointer to the 'KCIThreadId' to check.
...
the enabled KCIThread; In the disabled KCIThread, they always return
failure.  The exception is KCIThreadHandleGet(); it may be called in a
...
environment.  You can call KCIThreadIsMulti() to determine whether the
...
1.3.1.1    KCIThreadHandle - KCIThread Thread Handle
------------------------------------------------------

Type 'KCIThreadHandle' is used to manipulate a thread in the active
primitives:  KCIThreadJoin()and KCIThreadClose().  A thread handle opened by
KCIThreadCreate() must be closed in a matching call to
KCIThreadClose().  A thread handle is invalid after the call to
KCIThreadClose().

The distinction between a thread ID and a thread handle in KCIThread usage
...
KCIThreadHndInit - KCIThread HaNDle Initialize
----------------------------------------------
...
sword KCIThreadHndInit(void *hndl, KCIError *err,
KCIThreadHandle **thnd);
...
KCIThreadHndDestroy - KCIThread HaNDle Destroy
----------------------------------------------
...
sword KCIThreadHndDestroy(void *hndl, KCIError *err,
KCIThreadHandle **thnd);
...
'thnd' should be initialized by KCIThreadHndInit().


KCIThreadCreate - KCIThread Thread Create
-----------------------------------------
...
The call to KCIThreadCreate() must be matched by a call to
KCIThreadClose() if and only if tHnd is non-NULL.
...
KCIThreadJoin - KCIThread Thread Join
-------------------------------------
...
tHnd(IN):    The 'KCIThreadHandle' of the thread to join with.
...
KCIThreadClose - KCIThread Thread Close
---------------------------------------
...
tHnd(IN/OUT):    The KCIThread thread handle to close.
...
to KCIThreadCreate() are invalid after the call to KCIThreadClose().



KCIThreadHandleGet - KCIThread Thread Get Handle
------------------------------------------------

Description

Retrieve the 'KCIThreadHandle' of the thread in which it is called.

Prototype

sword KCIThreadHandleGet(void *hndl, KCIError *err,
KCIThreadHandle *tHnd);
...
with KCIThreadClose() and destroyed by KCIThreadHndDestroy() after it
is used.
...
KCIThread only requires that the process initialization function
('KCIThreadProcessInit()') be called when KCIThread is being used in a
multi-threaded application.  Failing to call 'KCIThreadProcessInit()' in
a single-threaded application is not an error.

* KCIThread initialization

Separate calls to 'KCIThreadInit()' will all return the same KCIThread
context.

Also, remember that each call to 'KCIThreadInit()' must eventually be
matched by a call to 'KCIThreadTerm()'.

* Active vs. Passive Threading primitives

KCIThread client code written without using any active primitives can be
compiled and used without change on both single-threaded and
multi-threaded platforms.

KCIThread client code written using active primitives will only work
...
by branching at runtime with the KCIThreadIsMulti() call.
...
/* KCIThread Context */
typedef struct KCIThreadContext KCIThreadContext;

/* KCIThread Mutual Exclusion Lock */
typedef struct KCIThreadMutex   KCIThreadMutex;

/* KCIThread Key for Thread-Specific Data */
typedef struct KCIThreadKey     KCIThreadKey;

/* KCIThread Thread ID */
typedef struct KCIThreadId      KCIThreadId;

/* KCIThread Thread Handle */
typedef struct KCIThreadHandle  KCIThreadHandle;


/*-------------------- KCI Thread Callback Function Pointers ----------------*/

/* KCIThread Key Destructor Function Type */
typedef void(*KCIThreadKeyDestFunc)(void  *);


/* Flags passed into KCIExtractFromXXX routines to direct processing         */
#define KCI_EXTRACT_CASE_SENSITIVE     0x1 /* matching is case sensitive     */
#define KCI_EXTRACT_UNIQUE_ABBREVS     0x2 /* unique abbreviations for keys
are allowed                    */
#define KCI_EXTRACT_APPEND_VALUES      0x4 /* if multiple values for a key
exist, this determines if the
new value should be appended
to (or replace) the current
list of values                 */

/* Constants passed into KCIExtractSetKey routine */
#define KCI_EXTRACT_MULTIPLE           0x8 /* key can accept multiple values */
#define KCI_EXTRACT_TYPE_BOOLEAN         1 /* key type is boolean            */
#define KCI_EXTRACT_TYPE_STRING          2 /* key type is string             */
#define KCI_EXTRACT_TYPE_INTEGER         3 /* key type is integer            */
#define KCI_EXTRACT_TYPE_KCINUM          4 /* key type is KCInum             */
...
sword KCIThreadIdSet(void  *hndl, KCIError *err,
	KCIThreadId *tidDest, KCIThreadId *tidSrc);

sword KCIThreadIdSetNull(void  *hndl, KCIError *err, KCIThreadId *tid);

sword KCIThreadIdGet(void  *hndl, KCIError *err, KCIThreadId *tid);
...
sword KCIThreadIdNull(void  *hndl, KCIError *err,
	KCIThreadId *tid, boolean *result);
...
sword KCIThreadHandleGet(void  *hndl, KCIError *err, KCIThreadHandle *tHnd);
/*----------------- End KCI Thread interface Extensions ---------------------*/

/*------------------ Begin KCI Row Callback Interfaces ----------------------*/

typedef sword(*KCIBindRowCallback)(void  *ctx);
typedef sword(*KCIFetchRowCallback)(void  *ctx);

/*------------------ Begin KCI Row Callback Interfaces ----------------------*/

/*--------------- Begin KCI Client Notification Interfaces ------------------*/

typedef ub4(*KCISubscriptionNotify)(void  *ctx, KCISubscription *subscrhp,
	void  *pay, ub4 payl,
	void  *desc, ub4 mode);

typedef ub4(*KCISubscriptionFailure)(void  *ctx, KCISubscription *subscrhp,
	void  *desc, KCIError *errhp);

sword KCISubscriptionRegister(KCISvcCtx *p_svctx, KCISubscription **subscrhpp,
	ub2 count, KCIError *errhp, ub4 mode);


sword KCISubscriptionPost(KCISvcCtx *p_svctx, KCISubscription **subscrhpp,
	ub2 count, KCIError *errhp, ub4 mode);

sword KCISubscriptionUnRegister(KCISvcCtx *p_svctx, KCISubscription *subscrhp,
	KCIError *errhp, ub4 mode);

sword KCISubscriptionDisable(KCISubscription *subscrhp,
	KCIError *errhp, ub4 mode);

sword KCISubscriptionEnable(KCISubscription *subscrhp,
	KCIError *errhp, ub4 mode);

/*------------------- End KCI Publish/Subscribe Interfaces ------------------*/
...
sword KCIDateTimeGetTimeZoneOffset(void  *hndl, KCIError *err,
	const KCIDateTime *datetime,
	sb1 *hr, sb1 *mm);
...
sword KCIDateTimeFromText(void  *hndl, KCIError *err, const KunText *date_str,
	size_t dstr_length, const KunText *fmt, ub1 fmt_length,
	const KunText *lang_name, size_t lang_length, KCIDateTime *date);
...
sword KCIIntervalFromNumber(void  *hndl, KCIError *err, KCIInterval *inter,
	KCINumber *number);
...
sword KCIIntervalToText(void  *hndl, KCIError *err, const KCIInterval *inter,
	...
	KunText *buffer, size_t buflen, size_t *resultlen);
...
sword KCIIntervalAssign(void  *hndl, KCIError *err, const KCIInterval *ininter,
	KCIInterval *outinter);

sword KCIIntervalSetYearMonth(void  *hndl, KCIError *err, sb4 yr, sb4 mnth,
	KCIInterval *result);

sword KCIIntervalGetYearMonth(void  *hndl, KCIError *err, sb4 *yr, sb4 *mnth,
	const KCIInterval *result);

sword KCIIntervalSetDaySecond(void  *hndl, KCIError *err, sb4 dy, sb4 hr,
	sb4 mm, sb4 ss, sb4 fsec, KCIInterval *result);

sword KCIIntervalGetDaySecond(void  *hndl, KCIError *err, sb4 *dy, sb4 *hr,
	sb4 *mm, sb4 *ss, sb4 *fsec, const KCIInterval *result);

sword KCIDateTimeToArray(void  *hndl, KCIError *err,
	const KCIDateTime *datetime, const KCIInterval *reftz,
	ub1 *outarray, ub4 *len, ub1 fsprec);

sword KCIDateTimeFromArray(void  *hndl, KCIError *err, ub1 *inarray, ub4 len,
	ub1 type, KCIDateTime *datetime,
	const KCIInterval *reftz, ub1 fsprec);

sword KCIDateTimeGetTimeZoneName(void  *hndl, KCIError *err,
	const KCIDateTime *datetime,
	ub1 *buf, ub4 *buflen);
...
sword KCIConnectionPoolCreate(KCIEnv *envhp,
	KCIError *errhp, KCICPool *poolhp,
	KunText **poolName, sb4 *poolNameLen,
	const KunText *dblink, sb4 dblinkLen,
	ub4 connMin, ub4 connMax, ub4 connIncr,
	const KunText *poolUserName, sb4 poolUserLen,
...
sword KCIConnectionPoolDestroy(KCICPool *poolhp,
	KCIError *errhp, ub4 mode);
...
sword KCISessionPoolCreate(KCIEnv *envhp, 
	KCIError *errhp, KCISPool *spoolhp,
	KunText **poolName, ub4 *poolNameLen,
	const KunText *connStr, ub4 connStrLen,
	ub4 sessMin, ub4 sessMax, ub4 sessIncr,
	KunText *userid, ub4 useridLen,
...
sword KCISessionPoolDestroy(KCISPool *spoolhp,
	KCIError *errhp,
	ub4 mode);

sword KCISessionGet(KCIEnv *envhp, KCIError *errhp, KCISvcCtx **p_svctx,
	KCIAuthInfo *authhp,KunText *poolName, ub4 poolName_len,
	const KunText *tagInfo, ub4 tagInfo_len,
	KunText **retTagInfo, ub4 *retTagInfo_len,
...
/*-------------------------------- KCIMemStats ------------------------------*/
sword  KCIMemStats(void     *hndlp, KCIError *errhp, KCIEnv   **envhp,
	ub4      mode, ub4      mode1, KunText     *tabname);

/*-------------------------------- KCIPing ----------------------------------*/
sword KCIPing(KCISvcCtx *p_svctx, KCIError *errhp, ub4 mode);

/*----------------- Kerberos Authentication prototypes ----------------------*/

sword KCIKerbAttrSet(KCISession *trgthndlp, ub4 cred_use, ub1 *ftgt_ticket,
	ub4 ticket_len, ub1 *session_key, ub4 skey_len,
	ub2 ftgt_keytype, ub4 ftgt_ticket_flags,
	sb4 ftgt_auth_time, sb4 ftgt_start_time,
	sb4 ftgt_end_time, sb4 ftgt_renew_time,
	KunText *ftgt_client_principal,
	ub4 ftgt_client_principal_len, KunText *ftgt_client_realm,
	ub4 ftgt_client_realm_len, KCIError *errhp);

/*------------------- End Kerberos Authentication prototypes ----------------*/

/*------------------- Database Startup/Shutdown prototypes ------------------*/

sword KCIDBStartup(KCISvcCtx     *p_svctx,
	KCIError      *errhp,
	KCIAdmin      *admhp,
	ub4            mode,
	ub4            flags);

sword KCIDBShutdown(KCISvcCtx     *p_svctx,
	KCIError      *errhp,
	KCIAdmin      *admhp,
	ub4            mode);
...
/*----------------------- KCIClientVersion ------------------------------*/
void KCIClientVersion(sword *major_version,
	sword *minor_version,
	sword *update_num,
	sword *patch_num,
	sword *port_update_num);
/*----------------------- End KCIClientVersion --------------------------*/

/*----------------------- HA Event prototypes ------------------------------*/

sword KCIInitEventHandle(KCIError *errhp,
	KCIEvent *event,
	text     *str,
	ub4       size);
...
sword KCITranslatedErrorGet(KCISvcCtx *p_svctx,
	void      *hndlp,
	ub4        recordno,
	KunText   *sqlstate,
	ub4        sqlstatesiz,
