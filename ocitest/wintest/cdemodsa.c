...
static text *username = (text *) "SYSDBA";                /* username */
static text *password = (text *) "SYSDBA";                /* password */
...
static void   describe_table(void);
static void   describe_column(OCIParam *parmp, ub4 parmcnt);
static void   describe_type(OCIParam *parmp);
static void   describe_typeattr(OCIParam *parmp, ub4 num_attr);
static void   describe_typecoll(OCIParam *parmp, sword typecode);
static void   describe_typemethodlist( OCIParam *parmp, ub4 num_meth,text *comment);
static void   describe_typemethod(OCIParam *parmp, text *comment);
static void   describe_typearg(OCIParam *parmp, ub1 type, ub4 start, ub4 end );
...
static void describe_type(OCIParam    *type_parmp)
{
  sword         retval;
...
static void   describe_typeattr(OCIParam      *attrlist_parmp,ub4            num_attr)
{
  OCIParam     *attr_parmp;
  sword         retval;
  text         *attr_name,
...
static void  describe_typecoll(OCIParam  *collelem_parmp,sword      coll_typecode)      /* OCI_TYPECODE_VARRAY or OCI_TYPECODE_TABLE */
{
  text         *attr_name,
               *schema_name,
               *type_name;
...
static void   describe_typemethodlist(OCIParam      *methodlist_parmp,ub4            num_method,text          *comment)
{
  sword      retval;
...
static void   describe_typemethod(OCIParam      *method_parmp,text          *comment)
{
  sword          retval;
  text          *method_name;
  ub4            size;
...
static void   describe_typearg (OCIParam      *arglist_parmp,ub1            type,ub4            start,ub4            end)
{
  OCIParam          *arg_parmp;
  sword              retval;
  text              *arg_name,
